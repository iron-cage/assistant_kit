...
The assistant workspace follows a pattern where Layer 2 CLI crates expose their commands
for aggregation by `assistant` (Layer 3).  Both `claude_runner` and `claude_storage`
