...
|----|------|---------|--------|
| 001 | [Rate Limit Reached](001_rate_limit_reached.md) | Document transient HTTP 429 rate-limit error and recovery | ✅ |
...
| 006 | [Quota Exhausted](006_quota_exhausted.md) | Document period quota exhaustion and account rotation recovery | ✅ |
