...
|------|------|----------------|
| source | `../../../../claude_auth/src/lib.rs` | `refresh_token`, `TOKEN_URL`, `CLIENT_ID`, `AuthError` |
| doc | `../../../../claude_profile/docs/feature/017_token_refresh.md` | Refresh trigger policy and credential write-back |
