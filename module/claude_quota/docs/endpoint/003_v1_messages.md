...
|------|------|----------------|
| source | `../../src/lib.rs` | `fetch_rate_limits`, `parse_headers`, `API_URL`, `ANTHROPIC_BETA`, `ANTHROPIC_VERSION` |
| doc | `../../../../claude_profile/docs/feature/013_account_limits.md` | `.account.limits` command — consumer of this endpoint |
