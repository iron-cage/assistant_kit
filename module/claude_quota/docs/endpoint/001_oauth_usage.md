...
|------|------|----------------|
| source | `../../src/lib.rs` | `fetch_oauth_usage`, `parse_oauth_usage`, `OAUTH_USAGE_URL` |
| doc | `../../../../claude_profile/docs/feature/009_token_usage.md` | `.usage` command — primary consumer of this endpoint |
| doc | `../../../../claude_profile/docs/feature/017_token_refresh.md` | Auth-error retry and refresh trigger |
