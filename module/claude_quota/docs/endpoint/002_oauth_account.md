...
|------|------|----------------|
| source | `../../src/lib.rs` | `fetch_oauth_account`, `parse_oauth_account`, `OAUTH_ACCOUNT_URL` |
| doc | `../../../../claude_profile/docs/feature/009_token_usage.md` | `.usage` command — consumer of this endpoint (Sub + ~Renews columns) |
| doc | `../../../../claude_profile/docs/feature/014_rich_account_metadata.md` | Rich metadata fields (reads local snapshot, not this API) |
