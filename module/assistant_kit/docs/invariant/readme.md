...
- **Purpose**: Document structural constraints that `assistant_kit` must always satisfy.
- **Responsibility**: Index of invariant doc instances covering the zero-own-logic constraint.
- **In Scope**: Zero-own-logic rule, re-export purity, dependency-set restrictions.
