...
Edge case coverage for the `version::` parameter. See [params.md](../../params.md) and [types.md](../../types.md) for specification.
...
**Source:** [params.md — version:: default: stable](../../params.md)
...
**Source:** [types.md — VersionSpec case-sensitive](../../types.md)
...
**Expected Output:** exit code 1.
**Pass Criteria:** Exit 1.
**Source:** [types.md — VersionSpec semver format](../../types.md)
...
**Expected Output:** exit code 1.
**Pass Criteria:** Exit 1.
**Source:** [types.md — VersionSpec no leading zeros](../../types.md)
...
**Expected Output:** exit code 1.
**Pass Criteria:** Exit 1.
**Source:** [types.md — VersionSpec format](../../types.md)
