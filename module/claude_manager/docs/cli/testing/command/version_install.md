...
Integration test planning for the `.version.install` command. See [commands.md](../../commands.md) for specification.
...
| TC-458 | `dry::2` → out-of-range boolean, exit 1 | N | 1 | F2=2 | new |

### Summary

- **Total:** 23 tests (16 positive, 7 negative)
- **Negative ratio:** 33.3% — supplemented by cross-cutting TC-242 to TC-244
- **Combined with cross-cutting:** 10/24 = 41.7% ✅
- **TC range:** TC-300 to TC-458
