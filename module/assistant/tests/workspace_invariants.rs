...
//! | Test | Spec | Scenario |
//! |------|------|----------|
//! | `wd1_workspace_members_completeness` | WD-1 | All 28 documented crates in members list |
...
/// All 28 workspace member crate names.
//
...
fn layer_of( name : &str ) -> Option< u8 >
{
  match name
  {
    "claude_core" | "claude_session_core" | "daemon_kit" | "child_supervisor" => Some( 0 ),
    "claude_assets_core"
    | "claude_profile_core"
    | "claude_version_core"
    | "claude_runner_core"
...
/// WD-1: All 28 documented workspace members are present in `[workspace.members]`.
///
