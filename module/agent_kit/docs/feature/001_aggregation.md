...
- **Purpose**: Specify the feature-gate re-export behavior of the `agent_kit` facade crate.
...
| pattern | workspace `docs/pattern/001_crate_layering.md` | Layer 2 dep rules governing `agent_kit`'s dependency set |
