...
Layer 2 library facade that re-exports all Layer 0–1 core crates under feature-gated modules.
...
| `manager` | `claude_manager_core` | Version detection, settings I/O, and install helpers |
...
# Cargo.toml
[dependencies]
agent_kit = { version = "~1.0", features = ["profile", "runner"] }
```

```rust,no_run
use agent_kit::profile::token::TokenStatus;
...
(`claude_profile_core`, `claude_runner_core`, `claude_manager_core`) plus the
