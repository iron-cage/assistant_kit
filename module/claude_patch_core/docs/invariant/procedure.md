...
Adding invariant document `002_kind_registry_uniqueness`:

1. Check `readme.md` Overview Table — current highest ID is `001`
2. Create `002_kind_registry_uniqueness.md` in this directory
3. Add row: `| 002 | Kind Registry Uniqueness | [002_kind_registry_uniqueness.md](002_kind_registry_uniqueness.md) | 🔄 |`
