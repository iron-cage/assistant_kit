...
Adding feature document `002_persistence_layer`:

1. Check `readme.md` Overview Table — current highest ID is `001`
2. Create `002_persistence_layer.md` in this directory
3. Add row: `| 002 | Persistence Layer | [002_persistence_layer.md](002_persistence_layer.md) | 🔄 |`
