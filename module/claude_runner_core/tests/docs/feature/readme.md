...
- **In Scope**: Feature docs 004 (`run_isolated`), 005 (`stdin_file`), 006 (`unset_claudecode`) and 007 (`bounded_fanout`).
...
| 007_bounded_fanout.md | Behavioral cases for `run_bounded()` — bound, ordering, isolation |
...
| [Bounded Fan-Out](../../../docs/feature/007_bounded_fanout.md) | [007_bounded_fanout.md](007_bounded_fanout.md) | 12 FT | ✅ |
