...
- **Responsibility**: Index of feature doc instances covering execution control, dry-run, command inspection, stdin file piping, CLAUDECODE environment unsetting, and bounded fan-out.
- **In Scope**: Execution mode design, dry-run semantics, describe/describe_compact output format, stdin_file piping, unset_claudecode default-on behavior, concurrency-bounded multi-child execution.
...
| 007 | [Bounded Fan-Out](007_bounded_fanout.md) | `run_bounded()` — many children, a fixed concurrency ceiling, results in input order | ✅ |
