...
Adding API document `002_watch_surface`:

1. Check `readme.md` Overview Table — current highest ID is `001`
2. Create `002_watch_surface.md` in this directory
3. Add row: `| 002 | Watch Surface | Change-notification contract for the registry | ✅ |`
