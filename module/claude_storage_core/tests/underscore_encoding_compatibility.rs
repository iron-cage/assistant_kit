...
//!
//! ```text
//! $ claude_storage .show.project /home/alice/projects/consumer-app/module/claude_storage/-default_topic
//! Error: Project not found: /home/alice/.claude/projects/-home-alice-projects-consumer-app-module-claude_storage--default_topic
//! ```
//!
//! The storage directory actually exists with hyphens:
//! `/home/alice/.claude/projects/-home-alice-projects-consumer-app-module-claude-storage--default-topic`
//!
...
fn test_real_claude_storage_path()
{
  ...
  let path = Path::new( "/home/alice/projects/consumer-app/module/claude_storage/-default_topic" );
  let encoded = encode_path( path ).unwrap();
  ...
  (
    encoded,
    "-home-alice-projects-consumer-app-module-claude-storage--default-topic"
  );
