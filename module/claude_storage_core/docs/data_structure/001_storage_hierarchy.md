...
| doc | `../../../../contract/claude_code/docs/behavior/007_concept_taxonomy.md` | User-facing four-level taxonomy (Project/Conversation/Session/Entry) that maps onto this storage model |
