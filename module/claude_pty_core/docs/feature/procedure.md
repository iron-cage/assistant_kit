...
Adding feature document `004_signal_forwarding`:

1. Check `readme.md` Overview Table — current highest ID is `003`
2. Create `004_signal_forwarding.md` in this directory
3. Add row: `| 004 | Signal Forwarding | Relay terminal signals to the child process group | ✅ |`
