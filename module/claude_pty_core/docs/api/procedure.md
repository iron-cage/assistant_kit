...
Adding API document `002_signal_surface`:

1. Check `readme.md` Overview Table — current highest ID is `001`
2. Create `002_signal_surface.md` in this directory
3. Add row: `| 002 | Signal Surface | Signal delivery contract for hosted children | ✅ |`
