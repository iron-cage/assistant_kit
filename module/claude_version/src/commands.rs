...
pub fn config_routine( cmd : VerifiedCommand, _ctx : ExecutionContext ) -> Result< OutputData, ErrorData >
{
  ...
  use claude_version_core::config_resolve::{ resolve, resolve_all };
  use claude_version_core::settings_io::remove_setting;
...
fn render_config_show_all(
  all  : &[ ( String, claude_version_core::config_resolve::ResolvedValue ) ],
  opts : &OutputOptions,
) -> String
{
  match opts.format
...
fn render_config_get(
  key  : &str,
  rv   : &claude_version_core::config_resolve::ResolvedValue,
  opts : &OutputOptions,
) -> String
{
  match opts.format
