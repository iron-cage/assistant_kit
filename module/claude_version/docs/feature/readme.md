...
| File | Responsibility |
|------|---------------|
| readme.md | Index and navigation for feature instances |
| procedure.md | Steps for adding, updating, or removing feature instances |
| 001_version_management.md | Install, guard, history, aliases, hot-swap |
| 002_process_lifecycle.md | Process listing, SIGTERM/SIGKILL sequence, verification |
| 003_settings_management.md | Read/write settings.json, type inference, nested preservation |
| 004_dry_run.md | Mutation preview via dry::1 across all mutation commands |
| 005_cli_design.md | Command routing, parameter parsing, exit codes, help listing |
