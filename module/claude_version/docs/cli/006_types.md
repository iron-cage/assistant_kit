...
- **In Scope**: 5 semantic types — VerbosityLevel, OutputFormat, VersionSpec, SettingsKey, SettingsValue.
- **Out of Scope**: Parameter reference (→ `005_params.md`), type inference algorithm (→ `../algorithm/`).

### All Types (5 total)

| # | Type | Base | Used By | Purpose |
|---|------|------|---------|---------|
| 1 | `VerbosityLevel` | u8 (0–2) | [`v::`](005_params.md#parameter--4-v) | Output detail control |
| 2 | `OutputFormat` | enum | [`format::`](005_params.md#parameter--5-format) | Display format selection |
| 3 | `VersionSpec` | String | [`version::`](005_params.md#parameter--1-version) | Release target identifier |
| 4 | `SettingsKey` | String | [`key::`](005_params.md#parameter--6-key) | Settings entry name |
| 5 | `SettingsValue` | String | [`value::`](005_params.md#parameter--7-value) | Settings entry value (type-inferred) |
...
- **Used by:** [`v::`](005_params.md#parameter--4-v)
...
- **Used by:** [`format::`](005_params.md#parameter--5-format)
...
- **Used by:** [`version::`](005_params.md#parameter--1-version)
...
- **Used by:** [`key::`](005_params.md#parameter--6-key)
...
- **Used by:** [`value::`](005_params.md#parameter--7-value)
