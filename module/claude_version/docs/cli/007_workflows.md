...
- **Purpose**: Common multi-step cm usage patterns.
- **Responsibility**: Operational scenarios combining multiple commands.
- **In Scope**: 5 workflow patterns for version management, process lifecycle, and settings.
