...
- **Purpose**: Reference for all cm commands with syntax, parameters, and exit codes.
- **Responsibility**: Per-command specification including accepted parameters, exit codes, and examples.
- **In Scope**: All 12 cm commands.
- **Out of Scope**: Parameter details (→ `005_params.md`), type definitions (→ `006_types.md`), behavioral contracts (→ `../feature/`).
...
|-----------|------|---------|-------------|
| [`v::`](005_params.md#parameter--4-v) | [`VerbosityLevel`](006_types.md#type--1-verbositylevel) | 1 | Output detail |
| [`format::`](005_params.md#parameter--5-format) | [`OutputFormat`](006_types.md#type--2-outputformat) | text | Output format |
...
| Parameter | Type | Default | Description |
|-----------|------|---------|-------------|
| [`version::`](005_params.md#parameter--1-version) | [`VersionSpec`](006_types.md#type--3-versionspec) | stable | Version to install |
| [`dry::`](005_params.md#parameter--2-dry) | bool | false | Preview install command |
| [`force::`](005_params.md#parameter--3-force) | bool | false | Bypass idempotency check |
| [`v::`](005_params.md#parameter--4-v) | [`VerbosityLevel`](006_types.md#type--1-verbositylevel) | 1 | Output detail |
| [`format::`](005_params.md#parameter--5-format) | [`OutputFormat`](006_types.md#type--2-outputformat) | text | Output format |

**Groups:** [Execution Control](003_parameter_groups.md#group--2-execution-control), [Output Control](003_parameter_groups.md#group--1-output-control)
...
| Parameter | Type | Default | Description |
|-----------|------|---------|-------------|
| [`version::`](005_params.md#parameter--1-version) | [`VersionSpec`](006_types.md#type--3-versionspec) | *(stored preference)* | Override preferred version for this invocation only |
| [`dry::`](005_params.md#parameter--2-dry) | bool | false | Preview without side effects |
| [`force::`](005_params.md#parameter--3-force) | bool | false | Reinstall even if version matches |
| [`interval::`](005_params.md#parameter--9-interval) | u64 | 0 | Seconds between checks; 0 = one-shot |
| [`v::`](005_params.md#parameter--4-v) | [`VerbosityLevel`](006_types.md#type--1-verbositylevel) | 1 | Output detail |
| [`format::`](005_params.md#parameter--5-format) | [`OutputFormat`](006_types.md#type--2-outputformat) | text | Output format |
...
| Parameter | Type | Default | Description |
|-----------|------|---------|-------------|
| [`dry::`](005_params.md#parameter--2-dry) | bool | false | Preview which processes would be killed |
| [`force::`](005_params.md#parameter--3-force) | bool | false | SIGKILL directly (skip SIGTERM) |
| [`v::`](005_params.md#parameter--4-v) | [`VerbosityLevel`](006_types.md#type--1-verbositylevel) | 1 | Output detail |
| [`format::`](005_params.md#parameter--5-format) | [`OutputFormat`](006_types.md#type--2-outputformat) | text | Output format |
...
| Parameter | Type | Default | Description |
|-----------|------|---------|-------------|
| [`key::`](005_params.md#parameter--6-key) | [`SettingsKey`](006_types.md#type--4-settingskey) | **(required)** | Setting to read |
| [`v::`](005_params.md#parameter--4-v) | [`VerbosityLevel`](006_types.md#type--1-verbositylevel) | 1 | Output detail |
| [`format::`](005_params.md#parameter--5-format) | [`OutputFormat`](006_types.md#type--2-outputformat) | text | Output format |

**Groups:** [Settings Identity](003_parameter_groups.md#group--3-settings-identity), [Output Control](003_parameter_groups.md#group--1-output-control)
...
| Parameter | Type | Default | Description |
|-----------|------|---------|-------------|
| [`key::`](005_params.md#parameter--6-key) | [`SettingsKey`](006_types.md#type--4-settingskey) | **(required)** | Setting to write |
| [`value::`](005_params.md#parameter--7-value) | [`SettingsValue`](006_types.md#type--5-settingsvalue) | **(required)** | Value to write |
| [`dry::`](005_params.md#parameter--2-dry) | bool | false | Preview without writing |

**Groups:** [Settings Identity](003_parameter_groups.md#group--3-settings-identity), [Execution Control](003_parameter_groups.md#group--2-execution-control)
...
| Parameter | Type | Default | Description |
|-----------|------|---------|-------------|
| [`count::`](005_params.md#parameter--10-count) | u64 | 10 | Number of recent releases to show |
| [`v::`](005_params.md#parameter--4-v) | [`VerbosityLevel`](006_types.md#type--1-verbositylevel) | 1 | Output detail |
| [`format::`](005_params.md#parameter--5-format) | [`OutputFormat`](006_types.md#type--2-outputformat) | text | Output format |
