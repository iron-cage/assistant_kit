...
- **Purpose**: Reference for all cm parameters with types, defaults, and validation rules.
- **Responsibility**: Per-parameter specification including type, default, valid values, and command applicability.
- **In Scope**: All 10 cm parameters.
- **Out of Scope**: Command reference (→ `001_commands.md`), type definitions (→ `006_types.md`), parameter interactions (→ `004_parameter_interactions.md`).

### All Parameters (10 total)

| # | Parameter | Type | Default | Valid Values | Description | Used In |
|---|-----------|------|---------|--------------|-------------|---------|
| 1 | `version::` | [`VersionSpec`](006_types.md#type--3-versionspec) | stable | stable, latest, month, semver | Version to install or guard | 2 cmds |
| 2 | `dry::` | bool | false | 0, 1 | Preview without executing | 4 cmds |
| 3 | `force::` | bool | false | 0, 1 | Bypass guards | 3 cmds |
| 4 | `v::` | [`VerbosityLevel`](006_types.md#type--1-verbositylevel) | 1 | 0 to 2 | Output detail level | 10 cmds |
| 5 | `format::` | [`OutputFormat`](006_types.md#type--2-outputformat) | text | text, json | Output format | 10 cmds |
| 6 | `key::` | [`SettingsKey`](006_types.md#type--4-settingskey) | **(required)** | Any text | Settings key | 2 cmds |
| 7 | `value::` | [`SettingsValue`](006_types.md#type--5-settingsvalue) | **(required)** | Any text | Settings value (type-inferred) | 1 cmd |
...
**Groups:** Parameters 4–5 form [Output Control](003_parameter_groups.md#group--1-output-control). Parameters 2–3 form [Execution Control](003_parameter_groups.md#group--2-execution-control). Parameters 6–7 form [Settings Identity](003_parameter_groups.md#group--3-settings-identity).
...
- **Type:** [`VersionSpec`](006_types.md#type--3-versionspec)
- **Default:** `stable`
- **Commands:** [`.version.install`](001_commands.md#command--4-version-install), [`.version.guard`](001_commands.md#command--5-version-guard)
...
- **Type:** bool
- **Default:** false (0)
- **Commands:** [`.version.install`](001_commands.md#command--4-version-install), [`.version.guard`](001_commands.md#command--5-version-guard), [`.processes.kill`](001_commands.md#command--8-processes-kill), [`.settings.set`](001_commands.md#command--11-settings-set)
- **Group:** [Execution Control](003_parameter_groups.md#group--2-execution-control)
...
- **Type:** bool
- **Default:** false (0)
- **Commands:** [`.version.install`](001_commands.md#command--4-version-install), [`.version.guard`](001_commands.md#command--5-version-guard), [`.processes.kill`](001_commands.md#command--8-processes-kill)
- **Group:** [Execution Control](003_parameter_groups.md#group--2-execution-control)
- **Validation:** strictly `0` or `1`; `true`, `yes`, `TRUE` etc. rejected with exit 1
...
- **Type:** [`VerbosityLevel`](006_types.md#type--1-verbositylevel)
- **Default:** 1 (normal)
- **Commands:** [`.status`](001_commands.md#command--2-status), [`.version.show`](001_commands.md#command--3-version-show), [`.version.install`](001_commands.md#command--4-version-install), [`.version.list`](001_commands.md#command--6-version-list), [`.version.guard`](001_commands.md#command--5-version-guard), [`.version.history`](001_commands.md#command--12-version-history), [`.processes`](001_commands.md#command--7-processes), [`.processes.kill`](001_commands.md#command--8-processes-kill), [`.settings.show`](001_commands.md#command--9-settings-show), [`.settings.get`](001_commands.md#command--10-settings-get)
- **Group:** [Output Control](003_parameter_groups.md#group--1-output-control)
...
- **Type:** [`OutputFormat`](006_types.md#type--2-outputformat)
- **Default:** text
- **Commands:** [`.status`](001_commands.md#command--2-status), [`.version.show`](001_commands.md#command--3-version-show), [`.version.install`](001_commands.md#command--4-version-install), [`.version.list`](001_commands.md#command--6-version-list), [`.version.guard`](001_commands.md#command--5-version-guard), [`.version.history`](001_commands.md#command--12-version-history), [`.processes`](001_commands.md#command--7-processes), [`.processes.kill`](001_commands.md#command--8-processes-kill), [`.settings.show`](001_commands.md#command--9-settings-show), [`.settings.get`](001_commands.md#command--10-settings-get)
- **Group:** [Output Control](003_parameter_groups.md#group--1-output-control)
...
- **Type:** [`SettingsKey`](006_types.md#type--4-settingskey)
- **Default:** **(required)**
- **Commands:** [`.settings.get`](001_commands.md#command--10-settings-get), [`.settings.set`](001_commands.md#command--11-settings-set)
- **Group:** [Settings Identity](003_parameter_groups.md#group--3-settings-identity)
...
- **Type:** [`SettingsValue`](006_types.md#type--5-settingsvalue)
- **Default:** **(required)**
- **Command:** [`.settings.set`](001_commands.md#command--11-settings-set)
- **Group:** [Settings Identity](003_parameter_groups.md#group--3-settings-identity)
...
- **Default:** 0 (one-shot)
- **Command:** [`.version.guard`](001_commands.md#command--5-version-guard)
...
- **Default:** 10
- **Command:** [`.version.history`](001_commands.md#command--12-version-history)
- **Group:** [Output Control](003_parameter_groups.md#group--1-output-control)
