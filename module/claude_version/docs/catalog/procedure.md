# Collection Documentation Operations
...
4. Add cross-references from any related feature or pattern doc instances via `### Collections`
...
## Retire Collection Instance

1. Remove the `NNN_*.md` file
2. Remove its row from `readme.md` Overview Table
3. Remove any `### Collections` cross-reference rows pointing to this instance from other doc instances
