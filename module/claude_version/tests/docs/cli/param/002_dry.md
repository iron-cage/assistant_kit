...
Edge case coverage for the `dry::` parameter. See [005_params.md](../../../../docs/cli/005_params.md) for specification.
...
- **Given:** clean environment
- **When:** `cm .version.install` (no `dry::` parameter present)
- **Then:** install proceeds as real action; no `[dry-run]` prefix; behavior identical to explicit `dry::0`
- **Exit:** 0
- **Source:** [005_params.md — dry:: default: 0](../../../../docs/cli/005_params.md)
...
- **When:** `cm .version.guard dry::0`
- **Then:** Behavior identical to `cm .version.guard`; no `[dry-run]` prefix.; explicit zero equals absent
- **Exit:** 0
- **Source:** [005_params.md — dry:: default: 0](../../../../docs/cli/005_params.md)
...
- **Then:** exit code 1.
- **Exit:** 1
- **Source:** [005_params.md — dry:: type: Boolean (0/1)](../../../../docs/cli/005_params.md)
