...
| `value_ec1_true_stored_as_boolean` | `tests/cli/value_param_test.rs` |
| `value_ec2_zero_stored_as_integer_not_boolean` | `tests/cli/value_param_test.rs` |
| `value_ec4_command_scope_rejects_on_get` | `tests/cli/value_param_test.rs` |
| `value_ec5_float_stored_as_json_float` | `tests/cli/value_param_test.rs` |
| `value_ec6_nan_stored_as_string` | `tests/cli/value_param_test.rs` |
| `value_ec7_round_trip_set_get` | `tests/cli/value_param_test.rs` |
| `value_ec8_infinity_stored_as_string` | `tests/cli/value_param_test.rs` |
| `value_ec9_space_in_value_stored_as_string` | `tests/cli/value_param_test.rs` |
| `value_ec11_false_stored_as_boolean` | `tests/cli/value_param_test.rs` |
| `value_ec12_integer_stored_unquoted` | `tests/cli/value_param_test.rs` |
| `value_ec13_string_stored_quoted` | `tests/cli/value_param_test.rs` |
| `value_ec10_empty_value_exits_1` | `tests/cli/value_param_test.rs` |
| `value_ec14_missing_value_exits_1` | `tests/cli/value_param_test.rs` |
| `value_ec15_missing_value_error_mentions_value_token` | `tests/cli/value_param_test.rs` |
