...
| EC-15 | `.version.show v::1` → semver as first token (digit-leading) | Explicit 1 |
...
| EC-20 | `.version.list mode::history v::0` → bare version+date | Explicit 0 |
| EC-21 | `.version.list mode::history v::2` → full changelog | Explicit 2 |
...
- **Given:** clean environment
- **When:** `clv .status v::0`, `clv .version.list v::0`, `clv .version.list mode::history v::0`
...
- **Then:** exit code 1; unknown parameter.; **Note:** `.ps.kill` was added to the v:: scope in TSK-099; only `.settings.set` and `.help` (universal override) do not accept v:: as a named parameter
- **Exit:** 1
- **Source:** [feature/005_cli_design.md](../../../../docs/feature/005_cli_design.md)
...
### EC-15: `.version.show v::1` → semver as first token (digit-leading)

- **Given:** clean environment
- **When:** `clv .version.show v::1`
- **Then:** exit 0; first whitespace-delimited token of stdout begins with an ASCII digit (semver); optional `[labels]` may follow
- **Exit:** 0
...
### EC-20: `.version.list mode::history v::0` → bare version+date
...
- **Exit:** 0
- **Source:** [command/version.md — .version.list mode::history v::0](../../../../docs/cli/command/version.md#command-6-versionlist)

---

### EC-21: `.version.list mode::history v::2` → full changelog

- **Given:** network available
- **When:** `clv .version.list mode::history v::2 count::2`
- **Then:** exit 0; output contains `##` markdown headers and `- ` bullet lines per release
- **Exit:** 0
- **Source:** [command/version.md — .version.list mode::history v::2](../../../../docs/cli/command/version.md#command-6-versionlist)
...
| `tc006_verbosity_out_of_range` | `tests/cli_args_test/param_verbosity_test.rs` |
| `tc007_verbosity_non_integer` | `tests/cli_args_test/param_verbosity_test.rs` |
| `tc008_verbosity_0_accepted` | `tests/cli_args_test/param_verbosity_test.rs` |
| `tc010_last_verbosity_wins` | `tests/cli_args_test/param_verbosity_test.rs` |
| `tc022_v_param_consistent` | `tests/cli_args_test/param_verbosity_test.rs` |
| `tc484_verbosity_canonical_out_of_range_rejected` | `tests/cli_args_test/param_verbosity_test.rs` |
| `tc485_verbosity_canonical_negative_rejected` | `tests/cli_args_test/param_verbosity_test.rs` |
| `tc486_verbosity_canonical_zero_accepted` | `tests/cli_args_test/param_verbosity_test.rs` |
| `tc245_last_occurrence_wins_for_verbosity` | `tests/cli/read_status_test.rs` |
| `tc503_verbosity_out_of_range_error_message` | `tests/cli/error_messages_test.rs` |
...
| `verbosity_ec11_command_scope_settings_set` | `tests/cli_args_test/param_verbosity_test.rs` |
| `verbosity_ec12_status_v0_bare_lines` | `tests/cli/verbosity_param_test.rs` |
| `verbosity_ec13_status_v1_labeled_lines` | `tests/cli/verbosity_param_test.rs` |
| `verbosity_ec14_version_show_v0_bare_semver` | `tests/cli/verbosity_param_test.rs` |
| `verbosity_ec15_version_show_v1_labeled` | `tests/cli/verbosity_param_test.rs` |
| `verbosity_ec16_version_list_v0_names_only` | `tests/cli/verbosity_param_test.rs` |
| `verbosity_ec17_version_list_v1_with_descriptions` | `tests/cli/verbosity_param_test.rs` |
| `verbosity_ec18_settings_show_v0_compact_format` | `tests/cli/verbosity_param_test.rs` |
| `verbosity_ec19_settings_get_v0_bare_value` | `tests/cli/verbosity_param_test.rs` |
| `verbosity_ec20_history_v0_bare_lines` | `tests/cli/verbosity_param_test.rs` |
| `verbosity_ec21_history_v2_full_changelog` | `tests/cli/verbosity_param_test.rs` |
