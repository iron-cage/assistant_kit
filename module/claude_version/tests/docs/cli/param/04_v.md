...
| `tc006_verbosity_out_of_range` | `cli_args_test/param_verbosity_test.rs` |
| `tc007_verbosity_non_integer` | `cli_args_test/param_verbosity_test.rs` |
| `tc008_verbosity_0_accepted` | `cli_args_test/param_verbosity_test.rs` |
| `tc010_last_verbosity_wins` | `cli_args_test/param_verbosity_test.rs` |
| `tc022_v_param_consistent` | `cli_args_test/param_verbosity_test.rs` |
| `tc484_verbosity_canonical_out_of_range_rejected` | `cli_args_test/param_verbosity_test.rs` |
| `tc485_verbosity_canonical_negative_rejected` | `cli_args_test/param_verbosity_test.rs` |
| `tc486_verbosity_canonical_zero_accepted` | `cli_args_test/param_verbosity_test.rs` |
...
| `verbosity_ec11_command_scope_settings_set` | `cli_args_test/param_verbosity_test.rs` |
