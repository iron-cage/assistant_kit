...
- **Input A:** `cm .version.list v::0 format::json` → JSON array output (CC-2)
- **Input B:** `cm .version.list v::1 format::text` → labeled text output (CC-6)
...
- **Given:** clean environment
- **When:** `cm .version.list v::0 format::json`
...
- **Given:** clean environment
- **When:** `cm .version.list v::2 format::json` and `cm .version.list v::0 format::json`
...
- **When:** `cm .status v::0`, `cm .version.list v::0`, `cm .settings.get key::k v::0`
...
- **Given:** clean environment
- **When:** `cm .status v::3 format::json`
...
- **Given:** clean environment
- **When:** `cm .status v::abc format::json`
