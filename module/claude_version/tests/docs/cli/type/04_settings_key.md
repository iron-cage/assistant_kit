...
| Function | File |
|----------|------|
| `tc_settings_key_empty_exits_1` | `tests/cli_args_test/type_surface_test.rs` |
| `tc_settings_key_absent_exits_1` | `tests/cli_args_test/type_surface_test.rs` |
| `tc_settings_key_dot_literal` | `tests/cli_args_test/type_surface_test.rs` |
| `tc_settings_key_valid_accepted` | `tests/cli_args_test/type_surface_test.rs` |
