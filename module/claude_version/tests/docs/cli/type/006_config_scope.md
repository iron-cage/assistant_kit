...
- **Out of Scope**: Config file I/O behavior (-> `../command/013_config.md`), key/value semantics (-> `007_config_key.md`).
...
- **When:** `cm .config key::theme value::dark scope::user`
...
- **When:** `cm .config key::theme value::dark scope::project`
...
- **Given:** clean HOME with `~/.claude/settings.json` containing `{}`
- **When:** `cm .config key::theme value::dark` (no `scope::` parameter)
...
- **When:** `cm .config key::theme value::dark scope::global`
...
- **Given:** clean environment
- **When:** `cm .config key::theme value::dark scope::`
