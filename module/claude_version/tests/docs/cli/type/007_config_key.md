...
- **Out of Scope**: Resolution algorithm (-> `../../algorithm/002_config_resolution.md`), value type inference (-> `005_settings_value.md`).
...
- **When:** `cm .config key::myCustomSetting`
...
- **When:** `cm .config` (no `key::` parameter)
