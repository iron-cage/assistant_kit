...
- **When:** `clv .version.install version::Y dry::1`
...
|----------|------|--------|
| `us01_002_version_install_dry_preview` | `tests/cli/user_story_test.rs` | ✅ |
| `us02_002_version_install_plan_accepted` | `tests/cli/user_story_test.rs` | ✅ |
| `us03_002_version_install_idempotent` | `tests/cli/user_story_test.rs` | ✅ |
| `us04_002_version_show_exits_0` | `tests/cli/user_story_test.rs` | ✅ |
| `us05_002_version_history_exits_0` | `tests/cli/user_story_test.rs` | ✅ |
| `us06_002_version_guard_exits_0` | `tests/cli/user_story_test.rs` | ✅ |
