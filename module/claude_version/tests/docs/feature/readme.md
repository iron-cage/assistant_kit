...
- **In Scope**: Feature test planning (FT- prefix, min 4 cases per spec). All 10 features.
...
| 010_custom_markers.md | FT- test cases for `.version.mark` CRUD, name validation, resolution, and list integration | ✅ |
