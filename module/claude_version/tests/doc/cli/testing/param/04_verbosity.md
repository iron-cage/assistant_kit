...
| EC-7 | `v::` accepted by 10 commands, rejected by 2 | Command Scope |
...
**Goal:** Commands without output formatting (`.settings.set`) reject `v::`.
**Setup:** None.
**Command:** `cm .settings.set v::1`
**Expected Output:** exit code 1; unknown parameter.
**Pass Criteria:** Exit 1.
**Note:** `.processes.kill` was added to the v:: scope in TSK-099; only `.settings.set` and `.help` (universal override) do not accept v:: as a named parameter.
**Source:** [feature/005_cli_design.md](../../../../../docs/feature/005_cli_design.md)
