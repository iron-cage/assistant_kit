#!/usr/bin/env bash
# Project-level runbox plugin for claude_version.
...
# The bin plugin and .claude mount are skipped for targeted runs;
...
_plugin_test_args()
{
  ...
  #   - skip the bin plugin and .claude mount (not needed for unit tests)
