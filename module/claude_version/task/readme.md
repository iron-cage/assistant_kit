...
| 5 | 005 | 672 | 8 | 7 | 6 | 2 | ❓ (Unverified) | any | ../claude_version_core/src/ | [Adopt unused version-pinning mechanisms in lock layer](unverified/005_adopt_unused_version_pinning_mechanisms.md) | Extend lock_version() with autoUpdatesChannel, minimumVersion, env.DISABLE_UPDATES |
