...
fn int_54_detail_omitted_matches_explicit_projects()
{
  ...
  assert_eq!(
    common::normalize_relative_time( &common::stdout( &out_default ) ),
    common::normalize_relative_time( &common::stdout( &out_explicit ) ),
...
fn int_65_limit_show_topic_noop_under_detail_projects()
{
  ...
  assert_eq!(
    common::normalize_relative_time( &common::stdout( &out_plain ) ),
    common::normalize_relative_time( &common::stdout( &out_with_noops ) ),
...
fn int_67_detail_uppercase_matches_lowercase()
{
  ...
  assert_eq!(
    common::normalize_relative_time( &common::stdout( &out_lower ) ),
    common::normalize_relative_time( &common::stdout( &out_mixed ) ),
