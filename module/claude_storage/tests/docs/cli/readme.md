...
- **In Scope**: All 13 clg commands, all 27 parameters, all 5 parameter groups, the command_group evaluation (0 qualifying groups), all 13 types, all 3 export formats, and all 6 user stories.
