...
- **In Scope**: All 15 clg commands, 27 of 39 parameters, all 5 parameter groups, the command_group evaluation (0 qualifying groups), 13 of 15 types, all 3 export formats, and all 6 user stories.
