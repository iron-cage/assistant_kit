# Parameter :: `show_metadata::`

Edge case tests for the `show_metadata::` parameter. Tests validate boolean enforcement and content suppression in `.show`.
...
| EC-5 | show_metadata::1 output includes entry count | Output Format |
| EC-6 | show_metadata::1 output includes session timestamps | Output Format |
...
**Behavioral Divergence Pair:** EC-1 (show_metadata::0, content shown) ↔ EC-2 (show_metadata::1, metadata only)
...
- **When:** `clg .show session_id::-default_topic show_metadata::0`
...
- **When:** `clg .show session_id::-default_topic show_metadata::true`
...
- **Then:** stdout contains conversation message content, identical to running with explicit `show_metadata::0`.; conversation content shown (default applied)
- **Exit:** 0
- **Source:** [param/06_metadata.md](../../../../docs/cli/param/06_metadata.md)
