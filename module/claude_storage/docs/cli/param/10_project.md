...
**Commands:** `.show`, `.count`, `.search`, `.export`, `.projects`
...
|---|---------|---------|-------|
| 2 | [`.list`](../command/02_list.md) (deprecated) | — | Historical: required for `type::conversation` mode, now `ids::` on `.projects` |
...
| 7 | [`.projects`](../command/07_projects.md) | — | Required for `ids::` scripting mode (see [`31_ids.md`](31_ids.md)) |
