...
Column [`.table`](../command/14_table.md)'s grouped rows are sorted by. Always operates on already-aggregated row totals — sorting happens after [`group::`](34_group.md), never before.
...
|---|---------|---------|-------|
| 14 | [`.table`](../command/14_table.md) | `total` | Paired with [`order::`](36_order.md) for direction |
