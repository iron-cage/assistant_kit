...
Sort direction applied to [`.table`](../command/14_table.md)'s [`sort::`](33_sort.md) column.
...
|---|---------|---------|-------|
| 14 | [`.table`](../command/14_table.md) | `desc` | Applies to whichever column [`sort::`](33_sort.md) names |
