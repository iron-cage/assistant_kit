...
| `command_group/` | Every command partitioned into exactly one group (Total Partition); shared handler + parameter set when multi-member (15 groups, all singletons) |
...
| `command/*.md` (15 files) | ➖ | ➖ | ✅ | ✅ | ✅ | L5 |
| `param/readme.md` | ➖ | ➖ | ✅ | ✅ | ✅ | L5 |
| `param/*.md` (39 files) | ➖ | ➖ | ✅ | ✅ | ✅ | L5 |
| `001_dictionary.md` | ➖ | ✅ | ✅ | ✅ | ✅ | L5 |
| `type/readme.md` | ➖ | ➖ | ✅ | ✅ | ✅ | L5 |
| `type/*.md` (15 files) | ➖ | ➖ | ✅ | ✅ | ✅ | L5 |
| `param_group/readme.md` | ➖ | ➖ | ✅ | ✅ | ✅ | L5 |
| `param_group/*.md` (5 files) | ➖ | ➖ | ✅ | ✅ | ✅ | L5 |
| `command_group/readme.md` (15 singleton groups) | ➖ | ➖ | ✅ | ✅ | ✅ | L5 |
| `003_workflows.md` | ➖ | ➖ | ✅ | ✅ | ✅ | L5 |
| `format/readme.md` | ➖ | ➖ | ✅ | ✅ | ✅ | L5 |
...
- [Command Groups](command_group/readme.md) — every command in exactly one group; 15 singleton groups, zero cross-calls found (Total Partition)
