...
See [004_params.md](004_params.md) for full parameter specs and [005_types.md](005_types.md) for type definitions.
...
|-----------|------|----------|---------|-------------|
| `path::` | [`StoragePath`](005_types.md#storagepath) | optional | `~/.claude/` | Storage root override |
| `verbosity::` | [`VerbosityLevel`](005_types.md#verbositylevel) | optional | `1` | Output detail level |

See [Output Control group](003_parameter_groups.md#output-control) for `verbosity` semantics.
...
| Parameter | Type | Required | Default | Description |
|-----------|------|----------|---------|-------------|
| `type::` | [`ProjectType`](005_types.md#projecttype) | optional | `all` | Project naming filter (`uuid`, `path`, `all`, `conversation`) |
| `path::` | [`PathSubstring`](005_types.md#pathsubstring) | optional | — | Filter projects by path substring |
| `sessions::` | Boolean | optional | `0` | Show sessions per project |
| `session::` | [`SessionFilter`](005_types.md#sessionfilter) | optional | — | Filter sessions by ID substring |
| `agent::` | Boolean | optional | — | Session type filter (`0`=main, `1`=agent) |
| `min_entries::` | [`EntryCount`](005_types.md#entrycount) | optional | — | Minimum entry count threshold |
| `verbosity::` | [`VerbosityLevel`](005_types.md#verbositylevel) | optional | `1` | Output detail level |
| `scope::` | [`ScopeValue`](005_types.md#scopevalue) | optional | `global` | Project discovery boundary |
...
Session filter parameters belong to the [Session Filter group](003_parameter_groups.md#session-filter). See [Output Control group](003_parameter_groups.md#output-control) for `verbosity` semantics. See [Scope Configuration group](003_parameter_groups.md#scope-configuration) for `scope::` semantics.
...
| Parameter | Type | Required | Default | Description |
|-----------|------|----------|---------|-------------|
| `session_id::` | [`SessionId`](005_types.md#sessionid) | optional | — | Session to display; when given without `project::`, the current project and all its topic variants are searched (scope::local) |
| `project::` | [`ProjectId`](005_types.md#projectid) | optional | current dir | Project identifier; when given with `session_id::`, restricts search to this project only |
| `entries::` | Boolean | optional | `0` | Show all entries in session |
| `metadata::` | Boolean | optional | `0` | Show metadata only (suppresses content) |
| `verbosity::` | [`VerbosityLevel`](005_types.md#verbositylevel) | optional | `1` | Output detail level |
| `scope::` | [`ScopeValue`](005_types.md#scopevalue) | optional | `local` | Project search boundary (Case 2 only: session_id without project::) |
| `path::` | [`StoragePath`](005_types.md#storagepath) | optional | cwd | Scope anchor path |

`session_id::` and `project::` belong to [Session Identification](003_parameter_groups.md#session-identification) and [Project Scope](003_parameter_groups.md#project-scope) groups. `scope::` and `path::` belong to the [Scope Configuration group](003_parameter_groups.md#scope-configuration).
...
| Parameter | Type | Required | Default | Description |
|-----------|------|----------|---------|-------------|
| `target::` | [`TargetType`](005_types.md#targettype) | optional | `projects` | What to count (`projects`, `sessions`, `entries`, `conversations`) |
| `project::` | [`ProjectId`](005_types.md#projectid) | optional | — | Scope to this project |
| `session::` | [`SessionId`](005_types.md#sessionid) | optional | — | Scope to this session |
| `scope::` | [`ScopeValue`](005_types.md#scopevalue) | optional | `global` | Count boundary |
| `path::` | [`StoragePath`](005_types.md#storagepath) | optional | cwd | Scope anchor path |

`project::` belongs to the [Project Scope group](003_parameter_groups.md#project-scope). `scope::` and `path::` belong to the [Scope Configuration group](003_parameter_groups.md#scope-configuration).
...
| `project::` | [`ProjectId`](005_types.md#projectid) | optional | — | Restrict to this project |
| `session::` | [`SessionId`](005_types.md#sessionid) | optional | — | Restrict to this session |
| `case_sensitive::` | Boolean | optional | `0` | Enable case-sensitive matching |
| `entry_type::` | [`EntryType`](005_types.md#entrytype) | optional | `all` | Filter by entry type |
| `verbosity::` | [`VerbosityLevel`](005_types.md#verbositylevel) | optional | `1` | Output detail level |
| `scope::` | [`ScopeValue`](005_types.md#scopevalue) | optional | `global` | Search boundary |
| `path::` | [`StoragePath`](005_types.md#storagepath) | optional | cwd | Scope anchor path |
...
| Parameter | Type | Required | Default | Description |
|-----------|------|----------|---------|-------------|
| `session_id::` | [`SessionId`](005_types.md#sessionid) | **required** | — | Session to export |
| `output::` | [`StoragePath`](005_types.md#storagepath) | **required** | — | Output file path |
| `format::` | [`ExportFormat`](005_types.md#exportformat) | optional | `markdown` | Export format |
| `project::` | [`ProjectId`](005_types.md#projectid) | optional | current dir | Source project |
| `scope::` | [`ScopeValue`](005_types.md#scopevalue) | optional | `local` | Project search boundary |
| `path::` | [`StoragePath`](005_types.md#storagepath) | optional | cwd | Scope anchor path |

`session_id::` belongs to [Session Identification](003_parameter_groups.md#session-identification). `project::` belongs to [Project Scope](003_parameter_groups.md#project-scope). `scope::` and `path::` belong to the [Scope Configuration group](003_parameter_groups.md#scope-configuration).
...
| Parameter | Type | Required | Default | Description |
|-----------|------|----------|---------|-------------|
| `scope::` | [`ScopeValue`](005_types.md#scopevalue) | optional | `around` | Session discovery scope |
| `path::` | [`StoragePath`](005_types.md#storagepath) | optional | cwd | Base path for scope resolution |
| `session::` | [`SessionFilter`](005_types.md#sessionfilter) | optional | — | Filter sessions by ID substring |
| `agent::` | Boolean | optional | — | Session type filter (`0`=main, `1`=agent) |
| `min_entries::` | [`EntryCount`](005_types.md#entrycount) | optional | — | Minimum entry count threshold |
...
`scope::` and `path::` belong to the [Scope Configuration group](003_parameter_groups.md#scope-configuration). Session filters belong to [Session Filter](003_parameter_groups.md#session-filter).
...
| Parameter | Type | Required | Default | Description |
|-----------|------|----------|---------|-------------|
| `path::` | [`StoragePath`](005_types.md#storagepath) | optional | cwd | Directory to compute storage path for |
| `topic::` | [`TopicName`](005_types.md#topicname) | optional | — | Session topic suffix (without leading `-`) |
...
| Parameter | Type | Required | Default | Description |
|-----------|------|----------|---------|-------------|
| `path::` | [`StoragePath`](005_types.md#storagepath) | optional | cwd | Directory to check |
| `topic::` | [`TopicName`](005_types.md#topicname) | optional | — | Session topic suffix (without leading `-`) |
...
| Parameter | Type | Required | Default | Description |
|-----------|------|----------|---------|-------------|
| `path::` | [`StoragePath`](005_types.md#storagepath) | optional | cwd | Base directory |
| `topic::` | [`TopicName`](005_types.md#topicname) | optional | `default_topic` | Session topic (without leading `-`) |
...
| `path::` | [`StoragePath`](005_types.md#storagepath) | optional | cwd | Base directory |
| `topic::` | [`TopicName`](005_types.md#topicname) | optional | `default_topic` | Session topic (without leading `-`) |
| `strategy::` | [`StrategyType`](005_types.md#strategytype) | optional | auto-detect | Override resume strategy |
