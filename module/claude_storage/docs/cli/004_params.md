...
See [005_types.md](005_types.md) for type definitions and [003_parameter_groups.md](003_parameter_groups.md) for related parameter sets.
...
| 4 | `entry_type::` | [`EntryType`](005_types.md#entrytype) | `all` | 1 | Filter search by entry type |
| 5 | `format::` | [`ExportFormat`](005_types.md#exportformat) | `markdown` | 1 | Export output format |
| 6 | `metadata::` | Boolean | `0` | 1 | Show metadata only mode |
| 7 | `min_entries::` | [`EntryCount`](005_types.md#entrycount) | — | 2 | Minimum entry count threshold |
| 8 | `output::` | [`StoragePath`](005_types.md#storagepath) | — | 1 | Export output file path |
| 9 | `path::` | varies | varies | 8 | Path argument (semantics vary by command) |
| 10 | `project::` | [`ProjectId`](005_types.md#projectid) | current dir | 5 | Project scope identifier |
| 11 | `query::` | String | — | 1 | Search query string |
| 12 | `scope::` | [`ScopeValue`](005_types.md#scopevalue) | varies | 6 | Session/project discovery scope |
| 13 | `session::` | [`SessionFilter`](005_types.md#sessionfilter) / [`SessionId`](005_types.md#sessionid) | — | 4 | Session filter (listing) or scope pin (count/search) |
| 14 | `session_id::` | [`SessionId`](005_types.md#sessionid) | — | 2 | Direct session identifier |
| 15 | `sessions::` | Boolean | `0` | 1 | Explicit session display toggle |
| 16 | `target::` | [`TargetType`](005_types.md#targettype) | `projects` | 1 | Count operation target |
| 17 | `topic::` | [`TopicName`](005_types.md#topicname) | — | 4 | Session topic suffix (without leading `-`) |
| 18 | `type::` | [`ProjectType`](005_types.md#projecttype) | `all` | 1 | Project naming scheme filter |
| 19 | `verbosity::` | [`VerbosityLevel`](005_types.md#verbositylevel) | `1` | 5 | Output detail level |
| 20 | `strategy::` | [`StrategyType`](005_types.md#strategytype) | auto-detect | 1 | Resume strategy override for `.session.ensure` |
...
(See [001_commands.md#command--2-list](001_commands.md#command--2-list) and [001_commands.md#command--7-projects](001_commands.md#command--7-projects))
...
**Commands:** `.search`
(See [001_commands.md#command--5-search](001_commands.md#command--5-search))
...
**Commands:** `.show`
(See [001_commands.md#command--3-show](001_commands.md#command--3-show))
...
**Type:** [`EntryType`](005_types.md#entrytype)
...
**Type:** [`ExportFormat`](005_types.md#exportformat)
...
**Commands:** `.export`
(See [001_commands.md#command--6-export](001_commands.md#command--6-export))
...
**Type:** [`EntryCount`](005_types.md#entrycount)
...
**Type:** [`StoragePath`](005_types.md#storagepath)
...
**Type:** [`StoragePath`](005_types.md#storagepath) or [`PathSubstring`](005_types.md#pathsubstring) depending on command
...
(See individual command sections in [001_commands.md](001_commands.md))
...
**Type:** [`ProjectId`](005_types.md#projectid)
...
**Type:** [`ScopeValue`](005_types.md#scopevalue)
...
**Type:** [`SessionFilter`](005_types.md#sessionfilter) (in `.list`, `.projects`) / [`SessionId`](005_types.md#sessionid) (in `.count`, `.search`)
...
**Type:** [`SessionId`](005_types.md#sessionid)
...
(See [001_commands.md#command--3-show](001_commands.md#command--3-show) and [001_commands.md#command--6-export](001_commands.md#command--6-export))
...
**Type:** [`TargetType`](005_types.md#targettype)
...
**Commands:** `.count`
(See [001_commands.md#command--4-count](001_commands.md#command--4-count))
...
**Type:** [`ProjectType`](005_types.md#projecttype)
...
**Type:** [`VerbosityLevel`](005_types.md#verbositylevel)
...
**Type:** [`TopicName`](005_types.md#topicname)
...
**Type:** [`StrategyType`](005_types.md#strategytype)
...
(See [001_commands.md#command--11-sessionensure](001_commands.md#command--11-sessionensure))
...
**Commands:** `.projects`
(See [001_commands.md#command--7-projects](001_commands.md#command--7-projects))
