...
See [004_params.md](004_params.md) for individual parameter specs and [001_commands.md](001_commands.md) for per-command usage.
...
|-----------|------|-------------|-------|
| `verbosity::` | [`VerbosityLevel`](005_types.md#verbositylevel) | Output detail: 0=silent, 1=normal, 2=detailed, 3=verbose | `v` |
...
|-----------|------|-------------|---------|
| `project::` | [`ProjectId`](005_types.md#projectid) | Project identifier (path, encoded ID, UUID, or Path(...) form) | current dir |
...
|-----------|------|----------|-------------|
| `session_id::` | [`SessionId`](005_types.md#sessionid) | optional in `.show`, required in `.export` | Session filename stem (without `.jsonl`) |
...
|-----------|------|-------------|-------------|
| `session::` | [`SessionFilter`](005_types.md#sessionfilter) | Filter sessions by ID substring | Auto-enables `sessions::1` |
| `agent::` | Boolean | `0`=main only, `1`=agent only, unset=all | Auto-enables `sessions::1` |
| `min_entries::` | [`EntryCount`](005_types.md#entrycount) | Minimum entry count threshold | Auto-enables `sessions::1` |
...
| Parameter | Type | Description | Default |
|-----------|------|-------------|---------|
| `scope::` | [`ScopeValue`](005_types.md#scopevalue) | Discovery strategy: `local`\|`relevant`\|`under`\|`global`\|`around` | `around` |
| `path::` | [`StoragePath`](005_types.md#storagepath) | Filesystem anchor for scope resolution | cwd |
