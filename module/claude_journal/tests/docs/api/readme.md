...
- **In Scope**: All `docs/api/` doc instances.
...
| Name | Purpose | Status |
|------|---------|--------|
| `001_journal_writer.md` | Test cases for the JournalWriter API | ✅ |
| `002_journal_reader.md` | Test cases for the JournalReader + JournalFilter API | ✅ |
| `003_event_type.md` | Test cases for EventType, EventRecord, EventFields | ✅ |
