...
Adding invariant document `003_names_are_single_components`:

1. Check `readme.md` Overview Table — current highest ID is `002`
2. Create `003_names_are_single_components.md` in this directory
3. Name `tests/identity_test.rs` as the enforcing check
4. Add row: `| 003 | Names Are Single Components | A topic name never contains a path separator | ✅ |`
