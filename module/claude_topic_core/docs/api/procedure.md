...
Adding API document `002_topic_stream_surface`:

1. Check `readme.md` Overview Table — current highest ID is `001`
2. Create `002_topic_stream_surface.md` in this directory
3. Add row: `| 002 | Topic Stream Surface | Incremental enumeration contract for a large base | ✅ |`
