...
fn generate_static_commands()
{
  ...
  // claude_manager uses programmatic registration (no YAML file).
  ...
  match aggregator.aggregate()
  {
    Ok( () ) =>
    {
      ...
      println!( "cargo:warning=claude_tools: generated static command registry" );
    }
