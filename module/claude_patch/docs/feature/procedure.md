...
Adding feature document `003_output_format`:

1. Check `readme.md` Overview Table — current highest ID is `002`
2. Create `003_output_format.md` in this directory
3. Add row: `| 003 | Output Format | [003_output_format.md](003_output_format.md) | 🔄 |`
