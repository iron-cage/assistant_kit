...
| `14_pattern.md` | EC- tests for the required-parameter rule and literal substring matching | ✅ |
| `15_port.md` | EC- tests for the default port and the ephemeral shortcut | ✅ |
| `16_bind.md` | EC- tests for the default loopback bind, the honored override, and bind failure | ✅ |
...
| `22_verbosity.md` | EC- tests for the three `.status` levels, clamping, and rejection | ✅ |
| `23_output.md` | EC- tests for the required-param rule and writing to a file | ✅ |
...
| `28_include_stdout.md` | EC- tests for unconditional output search and the flag's rejection | ✅ |
| `29_out.md` | EC- tests for `.chart`'s default path, the override, and `out` vs `output` | ✅ |
