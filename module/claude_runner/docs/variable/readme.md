...
| File | Responsibility |
|------|----------------|
| [001_claude_home.md](001_claude_home.md) | CLAUDE_HOME — base Claude config directory |
| [002_claude_projects_dir.md](002_claude_projects_dir.md) | CLAUDE_PROJECTS_DIR — session and memory root under CLAUDE_HOME |
| [003_claude_session_dir.md](003_claude_session_dir.md) | CLAUDE_SESSION_DIR — per-working-directory session storage |
| [004_claude_memory_dir.md](004_claude_memory_dir.md) | CLAUDE_MEMORY_DIR — per-git-root memory directory |
| [005_claude_memory_file.md](005_claude_memory_file.md) | CLAUDE_MEMORY_FILE — canonical MEMORY.md path |
| [006_claude_session_file.md](006_claude_session_file.md) | CLAUDE_SESSION_FILE — most recently active session file path |
