...
| `../../../claude_session_core/src/liveness.rs` | `/proc`-based PID liveness and incarnation predicates (`pid_alive`, `proc_starttime`) — the one copy, shared with the daemon stack |
