...
"Is this flag consumed by the claude subprocess?" — YES for all 14.
...
| [`--input-format`](../param/081_input_format.md) | enum | — | Input format selector | Input format (`text`/`stream-json`) |
