...
|---|-------|------------|---------|
| 1 | Claude-Native Flags | 14 | Pass selected `claude` binary flags through without runner modification |
| 2 | Runner Control | 53 | Control runner execution behavior -- before, during, or instead of subprocess invocation |
