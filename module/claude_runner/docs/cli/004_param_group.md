...
| [`--model`](param/003_model.md) | [`ModelName`](005_type.md#type--4-modelname) | — | Model selection | Model to use |
| [`--verbose`](param/004_verbose.md) | bool | false | Verbosity toggle | Enable Claude verbose output |
| [`--effort`](param/017_effort.md) | [`EffortLevel`](005_type.md#type--7-effortlevel) | max | Effort override | Reasoning effort level (default: max) |
| [`--json-schema`](param/023_json_schema.md) | [`JsonSchemaText`](005_type.md#type--10-jsonschematext) | — | Output structure constraint | JSON Schema for structured output |
| [`--mcp-config`](param/024_mcp_config.md) | [`McpConfigPath`](005_type.md#type--11-mcpconfigpath) | — | Tool server config | MCP server config (repeatable) |
...
- [`tests/docs/cli/param_group/001_claude_native_flags.md`](../../tests/docs/cli/param_group/001_claude_native_flags.md)
...
| [`--dir`](param/008_dir.md) | [`DirectoryPath`](005_type.md#type--2-directorypath) | cwd | Working directory | Working directory for subprocess |
| [`--max-tokens`](param/009_max_tokens.md) | [`TokenLimit`](005_type.md#type--3-tokenlimit) | 200000 | Token cap | Max output tokens |
| [`--session-dir`](param/010_session_dir.md) | [`DirectoryPath`](005_type.md#type--2-directorypath) | — | Session storage | Session storage directory |
| [`--dry-run`](param/011_dry_run.md) | bool | false | Execution gate | Preview without executing |
| [`--verbosity`](param/012_verbosity.md) | [`VerbosityLevel`](005_type.md#type--5-verbositylevel) | 3 | Diagnostic level | Runner output gate level |
...
| [`--file`](param/025_file.md) | [`FilePath`](005_type.md#type--12-filepath) | — | Stdin source | File content piped as subprocess stdin |
...
- [`tests/docs/cli/param_group/002_runner_control.md`](../../tests/docs/cli/param_group/002_runner_control.md)
...
| Parameter | Type | Default | Role in Group | Description |
|-----------|------|---------|---------------|-------------|
| [`--system-prompt`](param/015_system_prompt.md) | [`SystemPromptText`](005_type.md#type--6-systemprompttext) | — | Full replacement | Set system prompt (replaces the default) |
| [`--append-system-prompt`](param/016_append_system_prompt.md) | [`SystemPromptText`](005_type.md#type--6-systemprompttext) | — | Additive extension | Append text to the default system prompt |
...
- [`tests/docs/cli/param_group/003_system_prompt.md`](../../tests/docs/cli/param_group/003_system_prompt.md)
...
| Parameter | Type | Default | Role in Group | Description |
|-----------|------|---------|---------------|-------------|
| [`--creds`](param/019_creds.md) | [`CredentialsFilePath`](005_type.md#type--8-credentialsfilepath) | — | Credentials source | Credentials JSON file (required) |
| [`--timeout`](param/020_timeout.md) | [`TimeoutSecs`](005_type.md#type--9-timeoutsecs) | 30/45 | Duration limit | Max seconds to wait (30 isolated, 45 refresh) |
...
- [`tests/docs/cli/param_group/004_credential_operations.md`](../../tests/docs/cli/param_group/004_credential_operations.md)
