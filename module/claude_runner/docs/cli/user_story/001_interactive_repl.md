...
|---|-----------------|------|
| 2 | [Runner Control](../param_group/02_runner_control.md) | `--dir`, `--new-session` control REPL session |
...
| 10 | [`--session-dir`](../param/010_session_dir.md) | Deprecated, inert (BUG-493) — no longer overrides session storage |
