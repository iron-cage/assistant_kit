...
Edge case coverage for the `--effort` parameter. See [params.md](../../params.md#parameter--17---effort) for specification.
...
**Source:** [params.md — --effort](../../params.md#parameter--17---effort), [invariant/001_default_flags.md](../../../invariant/001_default_flags.md)
...
**Source:** [params.md — --effort](../../params.md#parameter--17---effort)
...
**Source:** [types.md — EffortLevel validation errors](../../types.md#type--7-effortlevel)
...
**Source:** [params.md — --effort (Validation)](../../params.md#parameter--17---effort)
