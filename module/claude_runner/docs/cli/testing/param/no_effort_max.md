...
Edge case coverage for the `--no-effort-max` parameter. See [params.md](../../params.md#parameter--18---no-effort-max) for specification.
...
**Source:** [params.md — --no-effort-max](../../params.md#parameter--18---no-effort-max), [invariant/001_default_flags.md](../../../invariant/001_default_flags.md)
...
**Source:** [params.md — --no-effort-max (Note: mutually exclusive)](../../params.md#parameter--18---no-effort-max)
...
**Source:** [invariant/001_default_flags.md](../../../invariant/001_default_flags.md)
