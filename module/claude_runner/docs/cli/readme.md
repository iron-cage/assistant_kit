...
| `env_param.md` | CLR_* env var fallbacks, CLR_GATE_DIR runtime config, and CLAUDE_CODE_* subprocess vars (42 vars) |
| `param_group/` | Logical parameter groupings (4 groups) |
| `type/` | Semantic type definitions (14 types) |
| `param/` | Individual parameter reference docs (39 parameters) |
...
| tests/docs/cli/param/ (39 files) | ➖ | ➖ | ➖ | ✅ | ✅ | Complete |
...
- [Parameters](param/readme.md) — flag and argument reference (39 parameters)
...
- [Env Parameters](env_param.md) — input, runtime config, and subprocess environment variables (42 variables)
