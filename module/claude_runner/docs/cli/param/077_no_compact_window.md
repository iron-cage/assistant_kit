...
`CLAUDE_CODE_AUTO_COMPACT_WINDOW=300000` in the subprocess environment for every running
command. This enables automatic context-window compaction at the 300,000-token mark, preventing
