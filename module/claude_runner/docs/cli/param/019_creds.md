...
- **Type:** [`CredentialsFilePath`](../005_type.md#type--8-credentialsfilepath)
- **Default:** — (required)
- **Command:** [`isolated`](../001_command.md#command--2-isolated), [`refresh`](../001_command.md#command--3-refresh)
