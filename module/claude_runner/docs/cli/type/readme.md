...
| 05_verbosity_level.md | Type spec: runner diagnostic output gate |
...
| 5 | `VerbosityLevel` | unsigned 8-bit integer | [`--verbosity`](../param/012_verbosity.md) | Runner diagnostic output gate (0-5) |
