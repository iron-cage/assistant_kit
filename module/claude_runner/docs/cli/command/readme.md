...
|---|---------|-------------|--------|---------|
| 1 | `run` (default) | Execute Claude Code with given parameters | 51 | `clr "Fix bug" --model sonnet` |
...
| 5 | `ask` | Semantic alias for run (identical defaults) | 51 | `clr ask "What does X do?"` |
