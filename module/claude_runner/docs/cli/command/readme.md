...
|---|---------|-------------|--------|---------|
| 1 | `run` (default) | Execute Claude Code with given parameters | 60 | `clr "Fix bug" --model sonnet` |
...
| 5 | `ask` | Semantic alias for run (identical defaults) | 60 | `clr ask "What does X do?"` |
