...
|---|---------|-------------|--------|---------|
| 1 | `run` (default) | Execute Claude Code with given parameters | 59 | `clr "Fix bug" --model sonnet` |
...
| 5 | `ask` | Semantic alias for run (identical defaults) | 59 | `clr ask "What does X do?"` |
