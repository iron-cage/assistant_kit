...
- **Purpose**: Index of doc entity directories for `claude_runner`.
- **Responsibility**: Master entity registry for all behavioral requirement doc entities under `docs/`.
- **In Scope**: Behavioral entities (`api/`, `feature/`, `invariant/`).
...
| `invariant/` | Index of invariant doc instances covering default flag injection and dependency constraints. | [invariant/readme.md](invariant/readme.md) | 2 |
