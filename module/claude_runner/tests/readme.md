...
**Responsibilities:** Automated integration tests for the `claude_runner` crate — CLI flag parsing, execution mode routing, dry-run output, verbosity behavior, YAML structure, stale-reference guards, and library API.
