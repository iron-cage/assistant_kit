...
| E10 | `CLR_SESSION_DIR` deprecated and inert (BUG-493) | `CLR_SESSION_DIR` | value absent from assembled command; stderr warning |
...
### E10: CLR_SESSION_DIR is deprecated and inert (BUG-493)

- **Given:** `CLR_SESSION_DIR=/tmp/e10sess`
- **When:** `clr --dry-run task`
- **Then:** stdout does NOT contain `/tmp/e10sess` (value applies no effect); stderr contains the one-line `--session-dir is deprecated` warning
- **Exit:** 0
- **Source:** [003_env_param.md §1](../../../../docs/cli/003_env_param.md)
