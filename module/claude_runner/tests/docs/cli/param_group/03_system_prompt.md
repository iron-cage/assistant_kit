...
Interaction test planning for the System Prompt parameter group. See [param_group/03_system_prompt.md](../../../../docs/cli/param_group/03_system_prompt.md) for specification.
...
| CC-5 | `--system-prompt` value contains special characters → forwarded verbatim | Corner Case |
...
- **Exit:** 0
- **Source:** [param_group/03_system_prompt.md](../../../../docs/cli/param_group/03_system_prompt.md)
- **Commands:** run, ask
...
- **Exit:** 0
- **Source:** [--system-prompt default: absent](../../../../docs/cli/param/015_system_prompt.md)
- **Commands:** run, ask

---

### CC-5: `--system-prompt` value contains special characters → forwarded verbatim

- **Given:** clean environment
- **When:** `clr --dry-run --system-prompt "You are helpful; always respond in JSON." "test"`
- **Then:** Assembled command contains `--system-prompt` with the exact value including semicolon and spaces; value is not split or interpreted as separate shell tokens
- **Exit:** 0
- **Source:** [param_group/03_system_prompt.md](../../../../docs/cli/param_group/03_system_prompt.md)
- **Commands:** run, ask
