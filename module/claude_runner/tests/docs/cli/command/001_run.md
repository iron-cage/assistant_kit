...
Integration test planning for the `run` command. See [001_command.md](../../../../docs/cli/001_command.md#command--1-run) for specification.
...
- **Exit:** 0
- **Source:** [001_command.md — run](../../../../docs/cli/001_command.md#command--1-run), [feature/001_runner_tool.md](../../../../docs/feature/001_runner_tool.md)
...
- **Exit:** 1
- **Source:** [005_type.md — EffortLevel validation](../../../../docs/cli/005_type.md#type--7-effortlevel)
