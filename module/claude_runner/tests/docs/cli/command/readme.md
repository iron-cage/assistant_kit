...
| `12_topics.md` | Integration tests for the `topics` command | ✅ |
| `13_daemon.md` | Integration tests for the `daemon` command | ✅ |
| `14_chat.md` | Integration tests for the `chat` command | ✅ |
| `15_sessions.md` | Integration tests for the `sessions` command | ✅ |
