...
- **Expected behavior:** Exit 0; caption reads `2 running (1 interactive, 1 print)`; parsed `I + P == N` (AF1)
- **Exit:** 0
...
- **Command:** `clr ps` (default `--mode all`)
- **Expected behavior:** Exit 0; caption reads `3 running (3 interactive, 0 print)`
- **Exit:** 0
- **Source:** [command/06_ps.md](../../../../docs/cli/command/06_ps.md), AC-010
...
- **Command:** `clr ps` (default `--mode all`)
- **Expected behavior:** Exit 0; caption reads `3 running (0 interactive, 3 print)`
- **Exit:** 0
- **Source:** [command/06_ps.md](../../../../docs/cli/command/06_ps.md), AC-010
