...
**Source:** [params.md](../../../../docs/cli/params.md#parameter--1-message)

## Test Case Index

| ID | Test Name | Category |
|----|-----------|----------|
| EC-1 | Single-word message → forwarded verbatim | Basic |
| EC-2 | Multi-word message → words joined with space | Basic |
