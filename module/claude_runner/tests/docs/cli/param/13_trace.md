...
- **Then:** Stderr contains exactly `# clr isolated`, `# creds: <path>`, and `# timeout: 30s` (the default isolated timeout); subprocess attempt fails (claude absent in test environment)
- **Exit:** 1
...
- **Then:** Stderr contains exactly `# clr refresh`, `# creds: <path>`, and `# timeout: 45s` (the default refresh timeout, distinct from isolated's 30s); subprocess attempt fails (claude absent in test environment)
- **Exit:** 1
- **Source:** [013_trace.md](../../../../docs/cli/param/013_trace.md), [invariant/004_trace_universality.md](../../../../docs/invariant/004_trace_universality.md)
- **Commands:** run, isolated, refresh, ask
