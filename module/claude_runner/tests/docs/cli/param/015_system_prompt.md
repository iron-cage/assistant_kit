...
Edge case coverage for the `--system-prompt` parameter. See [015_system_prompt.md](../../../../docs/cli/param/015_system_prompt.md) for specification.
...
- **Exit:** 1
- **Source:** [--system-prompt validation](../../../../docs/cli/param/015_system_prompt.md)
