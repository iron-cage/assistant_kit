...
Edge case coverage for the `--keep-claudecode` flag. See [27_keep_claudecode.md](../../../../docs/cli/param/27_keep_claudecode.md) for specification.
...
- **Exit:** 0
- **Source:** [--keep-claudecode](../../../../docs/cli/param/27_keep_claudecode.md)
