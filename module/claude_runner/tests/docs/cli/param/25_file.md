...
Edge case coverage for the `--file` parameter. See [25_file.md](../../../../docs/cli/param/25_file.md) for specification.
...
- **Exit:** 0
- **Source:** [--file](../../../../docs/cli/param/25_file.md)
...
- **Then:** Exit non-zero; stderr contains the file path and an error message
- **Exit:** non-zero
- **Source:** [--file](../../../../docs/cli/param/25_file.md)
...
- **Exit:** 0
- **Source:** [command.md — help](../../../../docs/cli/command.md#command--3-help)
