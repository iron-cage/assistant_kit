...
Edge case coverage for the `--no-ultrathink` parameter. See [014_no_ultrathink.md](../../../../docs/cli/param/014_no_ultrathink.md) for specification.
...
- **Exit:** 0
- **Source:** [--no-ultrathink (idempotent guard)](../../../../docs/cli/param/014_no_ultrathink.md)
...
- **Exit:** 0
- **Source:** [--no-ultrathink (applies only to message-bearing invocations)](../../../../docs/cli/param/014_no_ultrathink.md)
