...
| IN-6 | `KNOWN_SUBCOMMANDS` contains all 12 commands; no entry begins with `--` | Naming Invariant | ✅ |
...
### IN-6: `KNOWN_SUBCOMMANDS` contains all 12 commands; no entry begins with `--`
