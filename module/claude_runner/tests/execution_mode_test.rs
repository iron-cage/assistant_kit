...
use cli_binary_test_helpers::{ fake_claude, fake_claude_dir, make_continuable_from, run_with_path, run_with_path_env, run_with_path_stdin };
...
// Uses make_continuable_from (--from + CLAUDE_HOME) to guarantee -c injection regardless
