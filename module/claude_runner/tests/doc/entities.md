...
- **Purpose**: Index of test doc entity directories for `claude_runner`.
...
|------|---------|-------------|----------:|
| `cli/testing/command/` | Index of per-command integration test case files covering command-level behavior. | [cli/testing/command/readme.md](cli/testing/command/readme.md) | 2 |
