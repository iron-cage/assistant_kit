...
//! | ec10 | `ec10_owner_zero_clears_ownership` | `owner::0 name::X` → owner `""`, stdout `unclaimed` | P |
//! | ec11 | `ec11_owner_zero_no_name_batch_clears` | `owner::0` batch — clears owned, skips unowned | P |
//! | ec12 | `ec12_owner_zero_comma_list_batch_clear` | `owner::0 name::X,Y,Z` — clears all via comma-list | P |
//! | ec13 | `ec13_owner_set_comma_list_batch_set` | `owner::user name::X,Y,Z` — sets all via comma-list | P |
//! | ec14 | `ec14_owner_zero_force_bypasses_g8` | `owner::0 force::1` — G8 bypassed, foreign cleared | P |
//! | ec15 | `ec15_owner_zero_dry_run` | `owner::0 dry::1` — preview only, no write | P |
//! | ec16 | `ec16_owner_zero_force_dry_run` | `owner::0 force::1 dry::1` — bypass G8 + dry preview | P |
//! | ec17 | `ec17_owner_zero_unowned_clears_idempotent` | `owner::0 name::X` on unowned → idempotent exit 0 | P |
//! | ec18 | `ec18_owner_zero_g8_blocks_foreign_no_force` | `owner::0 name::X` foreign owner, no force → exit 1 | N |
//! | ec19 | `ec19_owner_zero_missing_json_exits_2` | `owner::0 name::X` — `.json` absent → exit 2 | N |
//! | ec20 | `ec20_owner_zero_batch_force_clears_foreign` | `owner::0 force::1` batch — clears foreign-owned | P |
