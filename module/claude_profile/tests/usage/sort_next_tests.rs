...
fn test_find_next_for_strategy_some_when_eligible_none_when_all_current()
{
  ...
  let winner_a = find_next_for_strategy( &accounts, SortStrategy::Name, PreferStrategy::Any, now, false, "anthropic", &TagFilter::default() );
  ...
  let winner_b = find_next_for_strategy( &all_current, SortStrategy::Name, PreferStrategy::Any, now, false, "anthropic", &TagFilter::default() );
...
fn test_all_strategies_skip_occupied_elsewhere()
{
  ...
  for strategy in [ SortStrategy::Renew, SortStrategy::Name, SortStrategy::Renews ]
  {
    let result = find_next_for_strategy( &no_free, strategy, PreferStrategy::Any, now, false, "anthropic", &TagFilter::default() );
    assert!(
      result.is_none(),
...
fn test_all_strategies_skip_h_exhausted()
{
  ...
  for strategy in [ SortStrategy::Renew, SortStrategy::Name, SortStrategy::Renews ]
  {
    let result = find_next_for_strategy( &boundary_accounts, strategy, PreferStrategy::Any, now, false, "anthropic", &TagFilter::default() );
    assert_eq!(
      result, Some( 1 ),
  ...
  for strategy in [ SortStrategy::Renew, SortStrategy::Name, SortStrategy::Renews ]
  {
    let result = find_next_for_strategy( &no_healthy, strategy, PreferStrategy::Any, now, false, "anthropic", &TagFilter::default() );
    assert!(
      result.is_none(),
...
fn test_cc_is_active_skips_account()
{
  ...
  for strategy in [ SortStrategy::Renew, SortStrategy::Name, SortStrategy::Renews ]
  {
    let result = find_next_for_strategy( &all_active, strategy, PreferStrategy::Any, now, false, "anthropic", &TagFilter::default() );
...
fn test_cc_expired_ok_account_skipped()
{
  ...
  for strategy in [ SortStrategy::Renew, SortStrategy::Name, SortStrategy::Renews ]
  {
    let result = find_next_for_strategy( &accounts, strategy, PreferStrategy::Any, now_secs, false, "anthropic", &TagFilter::default() );
    assert_eq!(
      result, Some( 1 ),
  ...
  for strategy in [ SortStrategy::Renew, SortStrategy::Name, SortStrategy::Renews ]
  {
    let result = find_next_for_strategy( &accounts_boundary, strategy, PreferStrategy::Any, now_secs, false, "anthropic", &TagFilter::default() );
    assert!(
      result.is_none(),
  ...
  for strategy in [ SortStrategy::Renew, SortStrategy::Name, SortStrategy::Renews ]
  {
    let result = find_next_for_strategy( &accounts_valid, strategy, PreferStrategy::Any, now_secs, false, "anthropic", &TagFilter::default() );
    assert_eq!(
      result, Some( 0 ),
...
fn test_cc_gate_ownership_rejects_non_owned()
{
  ...
  for strategy in [ SortStrategy::Renew, SortStrategy::Name, SortStrategy::Renews ]
  {
    ...
    let with_gate = find_next_for_strategy( &accounts, strategy, PreferStrategy::Any, now, true, "anthropic", &TagFilter::default() );
    assert_eq!(
      with_gate, Some( 1 ),
    ...
    let no_gate = find_next_for_strategy( &accounts, strategy, PreferStrategy::Any, now, false, "anthropic", &TagFilter::default() );
    assert_eq!(
      no_gate, Some( 0 ),
  ...
  for strategy in [ SortStrategy::Renew, SortStrategy::Name, SortStrategy::Renews ]
  {
    let result = find_next_for_strategy( &all_unowned, strategy, PreferStrategy::Any, now, true, "anthropic", &TagFilter::default() );
    assert!(
      result.is_none(),
...
fn test_cc_expired_ok_with_gate_ownership_true()
{
  ...
  for strategy in [ SortStrategy::Renew, SortStrategy::Name, SortStrategy::Renews ]
  {
    let result = find_next_for_strategy( &accounts, strategy, PreferStrategy::Any, now_secs, true, "anthropic", &TagFilter::default() );
    assert_eq!(
      result, Some( 1 ),
...
fn mre_bug336_find_next_excludes_account_in_one_point_weekly_band()
{
  ...
  let winner = find_next_for_strategy( &accounts, SortStrategy::Name, PreferStrategy::Any, now, false, "anthropic", &TagFilter::default() );
  assert_eq!(
    winner, Some( 1 ),
