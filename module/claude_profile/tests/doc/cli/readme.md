...
- **Purpose**: Test-lens documentation for the `clp` CLI — extends [`docs/cli/`](../../../docs/cli/readme.md) with test planning.
- **Responsibility**: Per-command, per-parameter, and per-group test case indices covering the `clp` binary.
