...
Integration and edge case coverage for the Output Control parameter group (`format::`). See [parameter_groups.md](../../../../docs/cli/param_group/001_output_control.md) for specification.
