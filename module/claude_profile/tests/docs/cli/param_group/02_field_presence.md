...
| EC-6 | Shared default-on params (`sub::`, `tier::`, `expires::`, `email::`) behave identically on both commands | Cross-Command Consistency |
...
| EC-10 | `token::` not accepted by `.accounts` | Non-Applicability |
