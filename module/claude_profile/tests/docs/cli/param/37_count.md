...
- **Exit:** 0
- **Source fn:** `it179_count_0_shows_all_rows` (in `usage_filter_test_b.rs`)
- **Source:** [param/037_count.md](../../../../docs/cli/param/037_count.md)
...
- **Exit:** 0
- **Source fn:** `it180_count_100_exceeding_shows_all` (in `usage_filter_test_b.rs`)
- **Source:** [param/037_count.md](../../../../docs/cli/param/037_count.md)
...
- **Exit:** 1
- **Source fn:** `it181_count_abc_exits_1` (in `usage_filter_test_b.rs`)
- **Source:** [param/037_count.md](../../../../docs/cli/param/037_count.md)
...
- **Exit:** 0
- **Source fn:** `it182_count_1_sort_name_shows_only_first` (in `usage_filter_test_b.rs`)
- **Source:** [param/037_count.md](../../../../docs/cli/param/037_count.md)
...
- **Exit:** 1
- **Source fn:** `it183_count_minus_1_exits_1` (in `usage_filter_test_b.rs`)
- **Source:** [param/037_count.md](../../../../docs/cli/param/037_count.md)
