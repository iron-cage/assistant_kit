...
- **Exit:** 0
- **Source fn:** `it184_offset_2_skips_first_2_rows` (in `usage_filter_test_b.rs`)
...
- **Exit:** 0
- **Source fn:** `it185_offset_0_shows_all_rows` (in `usage_filter_test_b.rs`)
- **Source:** [param/038_offset.md](../../../../docs/cli/param/038_offset.md)
...
- **Exit:** 0
- **Source fn:** `it186_offset_99_shows_empty` (in `usage_filter_test_b.rs`)
- **Source:** [param/038_offset.md](../../../../docs/cli/param/038_offset.md)
...
- **Exit:** 1
- **Source fn:** `it187_offset_abc_exits_1` (in `usage_filter_test_b.rs`)
- **Source:** [param/038_offset.md](../../../../docs/cli/param/038_offset.md)
...
- **Exit:** 0
- **Source fn:** `it188_offset_1_count_1_shows_second_row` (in `usage_filter_test_b.rs`)
- **Source:** [param/038_offset.md](../../../../docs/cli/param/038_offset.md)
...
- **Exit:** 1
- **Source fn:** `it189_offset_minus_1_exits_1` (in `usage_filter_test_b.rs`)
- **Source:** [param/038_offset.md](../../../../docs/cli/param/038_offset.md)
