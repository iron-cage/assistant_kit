...
Edge case tests for the `billing::` parameter. Tests validate boolean enforcement, default behavior, and billing type field control from `~/.claude.json` oauthAccount.
