...
EC-1 through EC-7's cited functions no longer exist in the test suite (confirmed via `git log -S`: last present
before the Feature 064 active-marker/owner redesign). EC-8 is the one exception: its cited function,
`ec8_multiple_at_splits_on_first`, was not deleted but repurposed in place — same name, body rewritten to drive
`assignee::` instead of `for::` — and is now the correctly-cited source for `64_assignee.md` EC-19, not for this
file's EC-8 scenario (see EC-8's own note below).
...
- **Exit:** 0
- **Source fn:** `aa02_remote_machine_marker_written` (N/A — removed with the feature)
...
- **Exit:** 0
- **Source fn:** `aa01_current_machine_marker_written` (N/A — removed with the feature)
- **Source:** [param/053_for.md](../../../../docs/cli/param/053_for.md)
...
- **Exit:** 1
- **Source fn:** `aa06_for_without_at_exits_1` (N/A — removed with the feature)
- **Source:** [param/053_for.md](../../../../docs/cli/param/053_for.md)
...
- **Exit:** 1
- **Source fn:** `aa07_empty_for_component_exits_1` (N/A — removed with the feature)
- **Source:** [param/053_for.md](../../../../docs/cli/param/053_for.md)
...
- **Exit:** 0
- **Source fn:** `aa08_special_chars_sanitized` (N/A — removed with the feature)
- **Source:** [param/053_for.md](../../../../docs/cli/param/053_for.md)
...
- **Source fn:** `ec8_multiple_at_splits_on_first` — still exists, but not as coverage of this scenario: the function was repurposed in place (same name, body rewritten) to drive `assignee::` instead of `for::`, and is now correctly cited as `64_assignee.md` EC-19's source. This file's `for::`-specific scenario has no live coverage.
- **Source:** [param/053_for.md](../../../../docs/cli/param/053_for.md)
