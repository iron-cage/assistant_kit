...
### EC-13: `imodel::auto` (`son_idle=false`) — subprocess uses `--model claude-haiku-4-5-20251001`

- **Given:** One account with `seven_day_sonnet=None` (Sonnet tier absent → `son_idle=false`). `imodel::auto touch::1`.
