...
- **Exit:** 0
- **Source fn:** `it130_effort_high_accepted_empty_store_exits_0` (in `usage_model_test.rs`)
- **Source:** [param/036_effort.md](../../../../docs/cli/param/036_effort.md)
...
- **Then:** Exits 0 with "(no accounts configured)". No error about unrecognized parameter.
- **Exit:** 0
- **Source fn:** `it131_effort_max_accepted_empty_store_exits_0` (in `usage_model_test.rs`)
- **Source:** [param/036_effort.md](../../../../docs/cli/param/036_effort.md)
...
- **Then:** Exits 0 with "(no accounts configured)". No error about unrecognized parameter. No subprocess spawned.
- **Exit:** 0
- **Source fn:** `it143_effort_low_accepted_empty_store_exits_0` (in `usage_model_test.rs`)
- **Source:** [param/036_effort.md](../../../../docs/cli/param/036_effort.md)
...
- **Then:** Exits 0 with "(no accounts configured)". No error about unrecognized parameter. No subprocess spawned.
- **Exit:** 0
- **Source fn:** `it144_effort_normal_accepted_empty_store_exits_0` (in `usage_model_test.rs`)
- **Source:** [param/036_effort.md](../../../../docs/cli/param/036_effort.md)
