...
|----|-----------|----------|
| EC-1 | `cols::+sub` shows Sub column in table header | Behavioral Divergence |
| EC-2 | `cols::-renews` hides Renews column from table header | Behavioral Divergence |
...
| EC-10 | `flag` and `account` columns always present regardless of `cols::` | Structural Columns Always-On |
...
- **Exit:** 1
- **Source fn:** `it204_cols_bogus_names_host_and_role_in_error` (in `usage_filter_test_b.rs`)
- **Source:** [param/033_cols.md](../../../../docs/cli/param/033_cols.md)
