...
- **Exit:** 0
- **Source fn:** `it155_only_active_0_shows_all_rows` (in `usage_filter_test.rs`)
- **Source:** [param/039_only_active.md](../../../../docs/cli/param/039_only_active.md)
...
- **Exit:** 1
- **Source fn:** `it156_only_active_bad_exits_1` (in `usage_filter_test.rs`)
- **Source:** [param/039_only_active.md](../../../../docs/cli/param/039_only_active.md)
...
- **Exit:** 0
- **Source fn:** `it157_only_active_1_no_active_marker_shows_empty` (in `usage_filter_test.rs`)
- **Source:** [param/039_only_active.md](../../../../docs/cli/param/039_only_active.md)
...
- **Exit:** 0
- **Source fn:** `it158_only_active_true_accepted` (in `usage_filter_test.rs`)
- **Source:** [param/039_only_active.md](../../../../docs/cli/param/039_only_active.md)
...
- **Exit:** 0
- **Source fn:** `it159_only_active_false_shows_all_rows` (in `usage_filter_test.rs`)
- **Source:** [param/039_only_active.md](../../../../docs/cli/param/039_only_active.md)
