...
- **Exit:** 0
- **Source fn:** `as30_role_writes_profile_json` (in `account_renewal_test_b.rs`)
...
- **Exit:** 0
- **Source fn:** `as31_role_omit_stores_empty` (in `account_renewal_test_b.rs`)
- **Source:** [param/052_role.md](../../../../docs/cli/param/052_role.md)
...
- **Exit:** 0
- **Source fn:** `as32_role_empty_stores_empty` (in `account_renewal_test_b.rs`)
- **Source:** [param/052_role.md](../../../../docs/cli/param/052_role.md)
...
- **Exit:** 0
- **Source fn:** `as33_role_resave_overwrites` (in `account_renewal_test_b.rs`)
- **Source:** [param/052_role.md](../../../../docs/cli/param/052_role.md)
...
- **Exit:** 0
- **Source fn:** `as34_role_with_spaces` (in `account_renewal_test_b.rs`)
- **Source:** [param/052_role.md](../../../../docs/cli/param/052_role.md)
