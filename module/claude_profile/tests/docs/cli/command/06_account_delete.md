...
Integration test planning for the `.account.delete` command. See [command/namespace.md](../../../../docs/cli/command/001_account.md#command-6-accountdelete) for specification.
