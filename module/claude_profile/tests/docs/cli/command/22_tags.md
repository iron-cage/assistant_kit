...
- **Covers**: AC-11, AC-12 (✅ implemented)

### Test Cases

| IT | AC | Scenario | Source fn |
|----|----|----------|-----------|
| IT-01 | AC-11 | Mixed fixture → sorted rows with account and filter counts | `account_tag_t11_tags_lists_union_sorted` |
| IT-02 | AC-11 | Untagged store → `(no tags)`, exit 0 | `account_tag_t11_tags_lists_union_sorted` (empty-store assertion) |
...
- ✅ Implemented — source fns live in `tests/cli/account_tag_test.rs` (fn names carry the `account_tag_` file prefix); IT-06 in `tests/cli/dot_test.rs`.
...
- **Exit:** 0
- **Source fn:** `account_tag_t11_tags_lists_union_sorted` *(empty-store assertion)*
- **Source:** [075_account_tags.md AC-11](../../../../docs/feature/075_account_tags.md)
...
- **Exit:** 0
- **Source fn:** `account_tag_t11_tags_lists_union_sorted` *(typo-hazard assertion)*
- **Source:** [075_account_tags.md AC-11](../../../../docs/feature/075_account_tags.md)
...
- **Exit:** 1
- **Source fn:** `account_tag_t17_tags_bad_format_exits_1`
