...
| FT-05 | AC-05 | `set::opus` → writes `claude-opus-4-6` | ✅ `ft05_set_opus_writes_full_id` |
| FT-06 | AC-06 | `set::sonnet` → writes `claude-sonnet-4-6` | ✅ `ft06_set_sonnet_writes_full_id` |
...
### FT-05: `set::opus` writes `claude-opus-4-6`
...
### FT-06: `set::sonnet` writes `claude-sonnet-4-6`
