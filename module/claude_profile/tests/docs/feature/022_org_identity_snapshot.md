...
- **Exit:** 0
- **Source fn:** `acc42_org_uuid_shows_from_roles_json` (in `accounts_list_test_b.rs`)
...
- **Exit:** 0
- **Source fn:** `acc46_org_name_shows_from_roles_json` (in `accounts_list_test_b.rs`)
...
- **Exit:** 0
- **Source fn:** `cred45_ft09_format_json_includes_all_5_org_fields` (in `credentials_test_b.rs`)
