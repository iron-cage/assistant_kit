...
- **Source fn:** `t07_model_override_writes_sonnet_at_15pct_boundary` (in `src/usage/api_tests.rs`); `test_render_footer_model_label_at_15pct_no_override` (in `src/usage/render_tests.rs`)
