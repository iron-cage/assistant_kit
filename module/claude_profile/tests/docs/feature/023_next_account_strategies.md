...
> Test functions in `tests/usage/sort_next_tests.rs` that previously referenced `NextStrategy`
> now reference `SortStrategy` directly.

No active test cases. All coverage lives in `020_usage_sort_strategies.md`.
