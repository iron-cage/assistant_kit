...
Feature behavioral requirement test cases for `docs/feature/018_live_monitor.md`. Each FT case maps to one acceptance criterion. Command-level tests (IT-N) are in [cli/command/09_usage.md](../cli/command/09_usage.md).
...
- **Exit:** 0
- **Source fn:** `f18_ft01_live_0_single_fetch`
