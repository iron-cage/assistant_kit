...
Structural compliance validation cases for the `docs/feature/` collection (39 files). Validates that all feature doc instances conform to the per-type H3 section format required by doc.rulebook.md § Feature Documentation : Rule 9a.
...
- **Scope:** All 39 `docs/feature/*.md` files
...
### DT-04: Sources section present in all 39 feature docs

- **Scope:** All 39 `docs/feature/*.md` files
- **Command:** `grep -l "### Sources" docs/feature/*.md | wc -l`
- **Expected:** `39`
- **Failure:** Count less than 39 — at least one feature doc is missing `### Sources`
...
- **Scope:** Feature docs that reference test files (approximately 22 of 39)
