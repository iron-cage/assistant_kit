...
| AC-08 | G10 fires (provider mismatch) | `inference_provider != selected_provider` → skipped | Unit test |
...
- **Source fn:** `mre_bug292_renew_skips_weekly_exhausted_even_with_soonest_renewal` (in `tests/usage/sort_next_tests_b.rs`)
...
- **Source fn:** `mre_bug324_green_account_eligible_when_7d_son_exhausted` (in `tests/usage/sort_next_tests_b.rs`)
- **Source:** [algorithm/004_eligibility_gates.md Gate 7](../../../docs/algorithm/004_eligibility_gates.md)
...
- **Source fn:** `test_cc_gate7_boundary_exactly_3pct_skipped_in_eligibility` (in `tests/usage/sort_next_tests_b.rs`)
- **Source:** [algorithm/004_eligibility_gates.md Gate 7](../../../docs/algorithm/004_eligibility_gates.md)
...
- **Source fn:** `mre_bug317_cancelled_not_recommended_by_find_next` (in `tests/usage/sort_next_tests_b.rs`)
...
- **Source fn:** `test_cc_gate_ownership_rejects_non_owned` (in `tests/usage/sort_next_tests.rs`) — asserts both the `gate_ownership=true` (this case) and `gate_ownership=false` (AC-07) branches in one test body
...
- **Source fn:** `test_cc_gate_ownership_rejects_non_owned` (in `tests/usage/sort_next_tests.rs`) — same test as AC-06, asserting both branches
- **Source:** [algorithm/004_eligibility_gates.md Gate 8](../../../docs/algorithm/004_eligibility_gates.md)
...
- **Source fn:** `test_cc_gate10_provider_mismatch_skips_account`, `test_cc_gate10_mismatch_not_bypassed_by_force_equivalent`, `test_cc_gate10_empty_inference_provider_treated_as_anthropic`, `test_cc_gate10_empty_and_explicit_anthropic_are_equivalent` (in `tests/usage/sort_next_tests_b.rs`) — this note previously read "(planned — not yet implemented)"; Gate 10 has since been implemented and tested, the placeholder was stale
