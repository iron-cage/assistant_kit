...
fully tested. The CLI binary layer adds `adapter`, `output`, and `commands` (18 commands
behind the `enabled` feature). Functional requirements live in [`docs/feature/`](docs/feature/) (FR-6 through FR-36);
