...
- **In Scope**: `find_first_eligible()` gates 1–6; `extra` closure gates 7–8; `gate_ownership` semantics; `is_owned` definition.
- **Out of Scope**: Positive selection after gating (→ algorithm/005); sort strategies (→ algorithm/007).
