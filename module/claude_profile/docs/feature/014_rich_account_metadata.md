...
| `src/registry.rs` | Registration of `display_name::`, `role::`, `billing::`, `model::` params |
| `claude_profile_core/src/account/` | `Account` struct with new fields; `save()` snapshots metadata files; `list()` reads snapshots |
