...
| bug | `task/claude_profile/bug/214_touch_fires_for_7d_exhausted_accounts.md` | BUG-214 (TSK-217, code applied): `apply_touch` fired subprocess for 7d-exhausted accounts — fixed via `seven_day_left()` guard; Docker L3 pending |
