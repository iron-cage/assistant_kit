...
| [063_explicit_ownership_claim.md](063_explicit_ownership_claim.md) | `owner::` param — CLI-exposed write path for setting owner to a non-empty value; G8 gate; `force::` bypass; mutual exclusion with `unclaim::1` |
