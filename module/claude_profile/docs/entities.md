...
| 004 | [feature/004_account_switch.md](feature/004_account_switch.md) | FR-9 | Atomic credential rotation to a named account |
...
| 009 | [feature/009_token_usage.md](feature/009_token_usage.md) | FR-14 | 7-day per-model token usage reporting |
...
| [cli/params.md](cli/params.md) | Per-parameter specification (name, verbosity, format, dry, field-presence) |
