...
**Format-capable commands:** [`.accounts`](../command/001_account.md#command-3-accounts), [`.paths`](../command/004_paths.md#command-8-paths), [`.usage`](../command/006_usage.md#command-9-usage), [`.credentials.status`](../command/002_credentials.md#command-10-credentialsstatus), [`.account.limits`](../command/001_account.md#command-11-accountlimits), [`.account.inspect`](../command/001_account.md#command-15-accountinspect), [`.model`](../command/007_model.md#command-18-model), [`.models`](../command/008_models.md#command-19-models), [`.provider.select`](../command/009_provider.md#command-21-providerselect)
