...
| `devuser@devbox.local` | `_active_devbox.local_devuser` |
...
clp .account.assign name::work@corp.com for::devuser@devbox
...
| # | Command | Role |
|---|---------|------|
| 1 | [`.account.assign`](../command/001_account.md#command-16-accountassign-removed-feature-037-migration-path-superseded-feature-064065) | Target machine identity for active-account marker |
