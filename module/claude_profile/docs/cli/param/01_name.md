...
- **Type:** [`AccountName`](../type/01_account_name.md) (post-resolution); [`AccountSelector`](../type/04_account_selector.md) (pre-resolution, adapter-layer)
...
- **Commands:** [`.accounts`](../command/account.md#command--3-accounts) *(optional)*, [`.account.save`](../command/account.md#command--4-accountsave) *(optional/inferred)*, [`.account.use`](../command/account.md#command--5-accountuse) **(required)**, [`.account.delete`](../command/account.md#command--6-accountdelete) **(required)**, [`.account.limits`](../command/account.md#command--11-accountlimits) *(optional/active)*, [`.account.relogin`](../command/account.md#command--12-accountrelogin) *(optional/active)*
