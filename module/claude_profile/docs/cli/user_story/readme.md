...
| 2 | [Account Onboarding](002_onboarding.md) | Developer adding or recovering an account | `.account.save`, `.accounts`, `.account.delete`, `.account.relogin`, `.account.renewal`, `.account.assign` |
