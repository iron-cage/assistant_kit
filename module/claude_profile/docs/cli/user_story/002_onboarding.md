...
| 6 | [`.accounts`](../command/001_account.md#command--3-accounts) | Cross-machine: write active-account marker for another host via `active::USER@MACHINE name::X` (Feature 064; formerly `.account.assign`) |
...
| 8 | [`active::`](../param/013_active.md) | Target `USER@MACHINE` for per-machine marker write (Feature 064; formerly `for::`) |
