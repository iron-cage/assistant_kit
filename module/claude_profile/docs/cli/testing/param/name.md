...
Edge case coverage for the `name::` parameter. See [params.md](../../params.md#parameter--1-name) and [types.md](../../types.md#type--1-accountname) for specification.
...
**Source:** [types.md -- AccountName](../../types.md#type--1-accountname)
...
**Source:** [params.md -- name::](../../params.md#parameter--1-name) (FR-16)
...
**Source:** [params.md -- name::](../../params.md#parameter--1-name) (FR-16 backward-compat)
...
**Source:** [params.md -- name::](../../params.md#parameter--1-name) (FR-18)
...
**Pass Criteria:** Exit 0; omitting optional `name::` routes to active-account path.
**Source:** [params.md -- name::](../../params.md#parameter--1-name) (FR-18 backward-compat)
