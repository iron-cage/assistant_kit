...
Edge case coverage for the `threshold::` parameter. See [params.md](../../params.md#parameter--4-threshold) and [types.md](../../types.md#type--4-warningthreshold) for specification.
...
**Source:** [params.md -- threshold::](../../params.md#parameter--4-threshold)
...
**Source:** [types.md -- WarningThreshold](../../types.md#type--4-warningthreshold)
