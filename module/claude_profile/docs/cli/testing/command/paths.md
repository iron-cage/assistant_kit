...
Integration test planning for the `.paths` command. See [commands.md](../../commands.md#command--8-paths) for specification.
...
**Source:** [commands.md — .paths](../../commands.md#command--8-paths)
