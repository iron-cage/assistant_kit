...
Integration test planning for the `.account.switch` command. See [commands.md](../../commands.md#command--5-accountswitch) for specification.
...
**Source:** [commands.md — .account.switch](../../commands.md#command--5-accountswitch)
