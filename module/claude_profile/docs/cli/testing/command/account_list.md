...
Integration test planning for the `.account.list` command. See [commands.md](../../commands.md#command--3-accountlist) for specification.
...
**Source:** [commands.md — .account.list](../../commands.md#command--3-accountlist)
