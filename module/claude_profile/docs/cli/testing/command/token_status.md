...
Integration test planning for the `.token.status` command. See [commands.md](../../commands.md#command--7-tokenstatus) for specification.
...
**Source:** [commands.md — .token.status](../../commands.md#command--7-tokenstatus)
