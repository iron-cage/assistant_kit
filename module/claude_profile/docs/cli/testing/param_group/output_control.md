...
Integration and edge case coverage for the Output Control parameter group (`v::`, `format::`). See [parameter_groups.md](../../parameter_groups.md#group--1-output-control) for specification.
...
**Source:** [parameter_groups.md -- Output Control](../../parameter_groups.md#group--1-output-control)
