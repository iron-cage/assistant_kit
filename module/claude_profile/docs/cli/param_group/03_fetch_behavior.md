...
|-----------|------|---------|-------------|
| [`refresh::`](../param/19_refresh.md) | `bool` | `1` | On 401/403 auth error, refresh token via isolated subprocess and retry once per account |
| [`live::`](../param/20_live.md) | `bool` | `0` | Enable continuous refresh loop (Ctrl-C to exit cleanly) |
| [`interval::`](../param/21_interval.md) | `u64` | `30` | Seconds between refresh cycles (≥ 30; validated only when `live::1`) |
| [`jitter::`](../param/22_jitter.md) | `u64` | `0` | Max random seconds added to each cycle delay (0 ≤ jitter ≤ interval; validated only when `live::1`) |
| [`trace::`](../param/23_trace.md) | `bool` | `0` | Print `[trace]` lines to stderr: credential reads, API calls, and refresh steps |

**Used By (1 command):** [`.usage`](../command/usage.md#command--9-usage)
