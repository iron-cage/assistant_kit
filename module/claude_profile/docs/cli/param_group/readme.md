...
| [005_display_control.md](005_display_control.md) | Display Control: `cols::`, `count::`, `offset::`, `only_active::`, `only_next::`, `min_5h::`, `min_7d::`, `only_valid::`, `exclude_exhausted::`, `no_color::` — column visibility, row filtering, display modifiers |
| [006_account_targeting.md](006_account_targeting.md) | Account Targeting: `host::`, `tags::` 📋, `inference_provider::` — metadata labels attached to saved account profiles (`role::` REMOVED when Feature 075 lands — superseded by `tags::`) |
...
| [Display Control](005_display_control.md) | `cols::`, `count::`, `offset::`, `only_active::`, `only_next::`, `min_5h::`, `min_7d::`, `only_valid::`, `exclude_exhausted::`, `no_color::` | `.usage`, `.accounts` (all 10) |
| [Account Targeting](006_account_targeting.md) | `host::`, `tags::` 📋, `inference_provider::` (`role::` REMOVED when Feature 075 lands) | `.account.save` (`host::`, `role::` until 075 lands, `inference_provider::`; `tags::` 📋); `.accounts` (`host::` display toggle; `inference_provider` default identity column; `tags::` subset row filter 📋); `.account.tag` (`tags::` replace mode 📋) |
