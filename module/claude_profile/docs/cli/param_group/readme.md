...
| [006_account_targeting.md](006_account_targeting.md) | Account Targeting: `host::`, `tags::`, `inference_provider::` — metadata labels attached to saved account profiles (`role::` REMOVED — superseded by `tags::`, Feature 075) |
...
| [Account Targeting](006_account_targeting.md) | `host::`, `tags::`, `inference_provider::` (`role::` REMOVED, Feature 075) | `.account.save` (`host::`, `inference_provider::`, `tags::`); `.accounts` (`host::` display toggle; `inference_provider` default identity column; `tags::` subset row filter); `.account.tag` (`tags::` replace mode) |
