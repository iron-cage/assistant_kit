...
| [feature/036_account_ownership.md](../../feature/036_account_ownership.md) | Ownership model — `.account.save` stamps `current_identity()` as owner; `.account.unclaim` clears ownership; `.account.assign` is marker-only |
