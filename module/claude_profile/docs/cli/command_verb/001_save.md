...
| [feature/036_account_ownership.md](../../feature/036_account_ownership.md) | Ownership model — `.account.save` is ownership-neutral (passes `owner: None`); `.accounts owner::0 name::X` clears ownership (Feature 064); `.accounts active::USER@MACHINE name::X` is marker-only (Feature 064) |
