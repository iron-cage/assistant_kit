...
Adding invariant document `003_no_allocation_per_char`:

1. Check `readme.md` Overview Table — current highest ID is `002`
2. Create `003_no_allocation_per_char.md` in this directory
3. Name `tests/render_test.rs` as the enforcing check
4. Add row: `| 003 | No Allocation Per Char | The scanner allocates per line, never per character | ✅ |`
