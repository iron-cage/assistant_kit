...
1. Create `runbox/docs/{dimension}/` directory
...
4. Register in `runbox/docs/readme.md` Responsibility Table: add row for the new directory
...
1. Create `runbox/docs/secret/` directory
...
4. Add row to `runbox/docs/readme.md`: `| \`secret/\` | Per-secret reference for all secret injection slots |`
