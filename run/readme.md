...
| `docker-run` | Universal Docker runner: reads docker.yml, builds and runs containers. |
| `docker.yml` | Workspace Docker config: image, build args, mounts, test script path. |
