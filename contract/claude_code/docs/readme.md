...
| Path | Responsibility |
|------|----------------|
| `behavior/` | Observed external behaviors of the `claude` binary — 36 instances (B1–B35 + B16h) |
...
| `format/` | Ancillary file formats — 7 instances (history, credentials, debug, shell-snapshots, todos, commands, JSON response) |
