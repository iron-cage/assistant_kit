...
- **Purpose**: Records the changelog for Claude Code release 2.1.98.
- **Responsibility**: Documents all features, fixes, and changes introduced in version 2.1.98.
- **In Scope**: All changelog entries published for version 2.1.98.
- **Out of Scope**: Prior and subsequent releases (see sibling version doc instances).

### Abstract

Added interactive Google Vertex AI setup wizard accessible from the login screen when selecting "3rd-party platform", guiding you through GCP authe...
