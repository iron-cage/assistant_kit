...
- **Purpose**: Records the changelog for Claude Code release 2.1.152.
- **Responsibility**: Documents all features, fixes, and changes introduced in version 2.1.152.
- **In Scope**: All changelog entries published for version 2.1.152.
- **Out of Scope**: Prior and subsequent releases (see sibling version doc instances).

### Abstract

`/code-review --fix` now applies review findings to your working tree after the review, surfacing reuse, simplificati...
