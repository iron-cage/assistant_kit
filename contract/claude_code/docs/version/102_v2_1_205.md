...
- **Purpose**: Records the changelog for Claude Code release 2.1.205.
- **Responsibility**: Documents all features, fixes, and changes introduced in version 2.1.205.
- **In Scope**: All changelog entries published for version 2.1.205.
- **Out of Scope**: Prior and subsequent releases (see sibling version doc instances).

### Abstract

Auto mode now includes a rule that blocks tampering with session transcript files.
