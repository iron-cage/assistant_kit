...
- **Purpose**: Records the changelog for Claude Code release 2.1.176.
- **Responsibility**: Documents all features, fixes, and changes introduced in version 2.1.176.
- **In Scope**: All changelog entries published for version 2.1.176.
- **Out of Scope**: Prior and subsequent releases (see sibling version doc instances).

### Abstract

Session titles are now generated in the language of your conversation (set the `language` setting to pin a specific l...
