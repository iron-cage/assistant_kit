...
- **Purpose**: Records the changelog for Claude Code release 2.1.193.
- **Responsibility**: Documents all features, fixes, and changes introduced in version 2.1.193.
- **In Scope**: All changelog entries published for version 2.1.193.
- **Out of Scope**: Prior and subsequent releases (see sibling version doc instances).

### Abstract

Added `autoMode.classifyAllShell` setting to route all Bash/PowerShell commands through the auto-mode classifier inst...
