...
- **Purpose**: Records the changelog for Claude Code release 2.1.140.
- **Responsibility**: Documents all features, fixes, and changes introduced in version 2.1.140.
- **In Scope**: All changelog entries published for version 2.1.140.
- **Out of Scope**: Prior and subsequent releases (see sibling version doc instances).

### Abstract

Improved Agent tool `subagent_type` matching to accept case- and separator-insensitive values (e.g. `"Code Reviewer"`...
