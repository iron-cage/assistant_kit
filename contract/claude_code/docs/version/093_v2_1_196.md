...
- **Purpose**: Records the changelog for Claude Code release 2.1.196.
- **Responsibility**: Documents all features, fixes, and changes introduced in version 2.1.196.
- **In Scope**: All changelog entries published for version 2.1.196.
- **Out of Scope**: Prior and subsequent releases (see sibling version doc instances).

### Abstract

Added support for organization default models — admins set it in the org console; it shows as "Org default" (or "Role...
