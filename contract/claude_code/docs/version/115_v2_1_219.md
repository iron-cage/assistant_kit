...
- **Purpose**: Records the changelog for Claude Code release 2.1.219.
- **Responsibility**: Documents all features, fixes, and changes introduced in version 2.1.219.
- **In Scope**: All changelog entries published for version 2.1.219.
- **Out of Scope**: Prior and subsequent releases (see sibling version doc instances).

### Abstract

Claude Opus 5 (`claude-opus-5`) is now the default Opus model, offering 1M context and fast mode at $10/$50 per Mtok.
