...
- **Purpose**: Records the changelog for Claude Code release 2.1.139.
- **Responsibility**: Documents all features, fixes, and changes introduced in version 2.1.139.
- **In Scope**: All changelog entries published for version 2.1.139.
- **Out of Scope**: Prior and subsequent releases (see sibling version doc instances).

### Abstract

Added agent view (Research Preview): a single list of every Claude Code session — running, blocked on you, or done. R...
