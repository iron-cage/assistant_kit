...
- **Purpose**: Records the changelog for Claude Code release 2.1.74.
- **Responsibility**: Documents all features, fixes, and changes introduced in version 2.1.74.
- **In Scope**: All changelog entries published for version 2.1.74.
- **Out of Scope**: Prior and subsequent releases (see sibling version doc instances).

### Abstract

Added actionable suggestions to `/context` command — identifies context-heavy tools, memory bloat, and capacity warnings with specific optimization...
