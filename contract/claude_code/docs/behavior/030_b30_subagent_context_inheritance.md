...
| tool | [../tool/007_agent.md](../tool/007_agent.md) | Agent tool — `prompt` parameter note: "agents start fresh unless `subagent_type: \"fork\"` is used" (no `resume` parameter exists) |
