...
- **In Scope**: Concept taxonomy (Project/Conversation/Session/Entry hierarchy), session behavior catalog, storage organization, filesystem layout, JSONL entry format, settings format, ancillary file formats.
...
|----|------|---------|--------|
| 001 | [Session Behaviors](001_session_behaviors.md) | Observed external behaviors (B1–B24) with evidence and invalidation tests | ✅ |
