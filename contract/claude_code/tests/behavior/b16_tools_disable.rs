...
//!
//! See `docs/behavior/readme.md` B16 for the full behavior record.
//! See `docs/behavior/readme.md` E30–E32 for supporting evidence.
...
// Manual validation procedure (from behavior/readme.md B16):
//
